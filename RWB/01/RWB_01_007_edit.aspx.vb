Partial Class RWB_01_007_edit
    ...
    Private Sub LoadData1(ByVal iSEQNO As Integer)
        ...
        If dt.Rows.Count > 0 Then
            ...
            schCONTENT1.Text = HttpUtility.HtmlDecode(Convert.ToString(dr("C_CONTENT1")))
    ...
    Function CheckData1(ByRef Errmsg As String) As Boolean
        ...
        schCONTENT1.Text = HttpUtility.HtmlEncode(TIMS.ClearSQM2(schCONTENT1.Text))  'edit，by:20190102
    ...
    Sub SaveData1()
        ...
        If flagSaveOK1 Then '儲存成功
            Dim url1 As String = "RWB_01_007.aspx?id1=" & TIMS.Get_MRqID(Me)
    ...
    Function SaveData2() As Boolean
        ...
        schCONTENT1.Text = HttpUtility.HtmlEncode(TIMS.ClearSQM2(schCONTENT1.Text))  'edit，by:20190102
        Dim oC_SDATE As Object = IIf(flag_ROC, TIMS.Cdate18(schC_SDATE1.Text), schC_SDATE1.Text) + " " + ddlC_SDATE_hh1.SelectedValue + ":" + ddlC_SDATE_mm1.SelectedValue + ":00.000"  'edit，by:20181019
        Dim oC_EDATE As Object = IIf(flag_ROC, TIMS.Cdate18(schC_EDATE1.Text), schC_EDATE1.Text) + " " + ddlC_EDATE_hh1.SelectedValue + ":" + ddlC_EDATE_mm1.SelectedValue + ":00.000"  'edit，by:20181019
    ...
    Protected Sub bt_cancle_Click(sender As Object, e As EventArgs) Handles bt_cancle.Click
        Dim url1 As String = ""
        url1 = "RWB_01_007.aspx?id1=" & TIMS.Get_MRqID(Me)
        TIMS.Utl_Redirect(Me, objconn, url1)
    End Sub
End Class