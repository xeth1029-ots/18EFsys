Partial Class RWB_01_009_edit
    ...
    Sub SaveData1()
        ...
        If flagSaveOK1 Then
            '儲存成功
            Dim url1 As String = "RWB_01_009.aspx?id1=" & TIMS.Get_MRqID(Me)
    ...
    Protected Sub bt_cancle_Click(sender As Object, e As EventArgs) Handles bt_cancle.Click
        Dim url1 As String = ""
        url1 = "RWB_01_009.aspx?id1=" & TIMS.Get_MRqID(Me)
        TIMS.Utl_Redirect(Me, objconn, url1)
    End Sub
End Class