<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_002.aspx.vb" Inherits="WDAIIP.RWB_01_002" %>
                ...
                <td align="center">
                    <asp:DataGrid ID="DataGrid1" runat="server" CssClass="font" AllowPaging="True" Width="100%" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="C_TITLE" HeaderText="連結標題" ItemStyle-Width="50%">
