<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_001_edit2.aspx.vb" Inherits="WDAIIP.RWB_01_001_edit2" %>
    ...
    <form id="form1" method="post" runat="server" enctype="multipart/form-data">
        ...
        <table class="table_nw" width="100%" cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td class="whitecol">
                    <asp:Label ID="lblType" runat="server">成果集錦</asp:Label></td>
            </tr>
            <tr>
                <td width="20%" class="bluecol_need">上稿日期：</td>
                <td class="whitecol">
                    <asp:Label ID="lblCDATE1" runat="server"></asp:Label></td>
            </tr>
            <tr>
        ...
        <table width="100%">
            <tr>
                <td class="whitecol" align="center">
                    <asp:Button ID="bt_save" runat="server" Text="儲存" CssClass="asp_button_M" AuthType="SAVE"></asp:Button>
                    <asp:Button ID="bt_cancle" runat="server" Text="取消" CausesValidation="False" CssClass="asp_button_M" AuthType="CANCLE"></asp:Button>&nbsp;
                </td>
            </tr>
            <tr>
