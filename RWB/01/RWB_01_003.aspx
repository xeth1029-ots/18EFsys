<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_003.aspx.vb" Inherits="WDAIIP.RWB_01_003" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <table class="table_nw" width="100%" cellpadding="1" cellspacing="1">
            <tr>
                <td width="20%" class="bluecol">類別：</td>
                <td class="whitecol">
            ...
            <tr>
                <td width="20%" class="bluecol">計畫：</td>
                <td class="whitecol">
            ...
            <tr>
                <td width="20%" class="bluecol">標題關鍵字：</td>
                <td class="whitecol">
                    <asp:TextBox ID="schKeyword1" Width="80%" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td align="center">
                    <asp:DataGrid ID="DataGrid1" runat="server" CssClass="font" AllowPaging="True" Width="100%" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TITLE1" HeaderText="標題" ItemStyle-Width="50%">
