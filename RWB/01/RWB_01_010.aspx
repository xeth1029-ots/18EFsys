<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_010.aspx.vb" Inherits="WDAIIP.RWB_01_010" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <table class="table_nw" width="100%" cellpadding="1" cellspacing="1">
            ...
            <tr>
                <td width="20%" class="bluecol">控制方式：</td>
                <td class="whitecol">
                    <asp:RadioButtonList ID="schrblCTRLITEM1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                ...
                <td align="center">
                    <asp:DataGrid ID="DataGrid1" runat="server" CssClass="font" AllowPaging="True" Width="100%" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="CEDATE" HeaderText="控制結束日期" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="15%"></asp:BoundColumn>
                            <asp:BoundColumn DataField="CCTRLITEM" HeaderText="控制方式" ItemStyle-Width="40%">
