<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_009_edit.aspx.vb" Inherits="WDAIIP.RWB_01_009_edit" %>
        ...
        <table id="FrameTable" border="0" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;報名網維護&gt;&gt;提醒視窗</asp:Label>
                </td>
            </tr>
        </table>
        <br>
