Partial Class RWB_01_010
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not Session("_SearchStr") Is Nothing Then
                ...
                schrblCTRLITEM1.SelectedIndex = schrblCTRLITEM1.Items.IndexOf(schrblCTRLITEM1.Items.FindByValue(TIMS.GetMyValue(Session("_SearchStr"), "schrblCTRLITEM1")))
    ...
    Sub sCreate1()
        ...
        schC_SDATE1.Text = ""
        schC_SDATE2.Text = ""
        schrblCTRLITEM1.SelectedValue = "1"
        schC_EDATE1.Text = ""
        schC_EDATE2.Text = ""
    End Sub
    ...
    Sub sSearch1()
        ...
        Dim vCTRLITEM1 As String = TIMS.ClearSQM(schrblCTRLITEM1.SelectedValue)
        ...
        If vCTRLITEM1 <> "" Then sql &= " AND a.C_CTRLITEM = @C_CTRLITEM " & vbCrLf
        ...
        If vCTRLITEM1 <> "" Then parms.Add("C_CTRLITEM", vCTRLITEM1)
        Dim dt As DataTable
    ...
    Protected Sub bt_add_Click(sender As Object, e As EventArgs) Handles bt_add.Click
        Dim url1 As String = "RWB_01_010_edit.aspx?id1=" & TIMS.Get_MRqID(Me)
    ...
    Sub GetSearchStr()
        ...
        Session("_SearchStr") += "&schrblCTRLITEM1=" & schrblCTRLITEM1.SelectedValue
