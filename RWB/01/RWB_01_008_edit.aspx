<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RWB_01_008_edit.aspx.vb" Inherits="WDAIIP.RWB_01_008_edit" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>頁底版權資訊維護</title>
    ...
    <form id="form1" method="post" runat="server">
        <table id="FrameTable" border="0" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;報名網維護&gt;&gt;頁底版權資訊維護</asp:Label>
                </td>
            </tr>
        </table>
        <br>
        <table class="table_nw" width="100%" cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td class="whitecol">
                    <asp:TextBox ID="schC_CDATE1" Width="120px" onfocus="this.blur()" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
