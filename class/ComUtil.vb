...
Public Class ComUtil
    ...
    ' 傳回顯示訊息並導入某一頁面
    Public Shared Function show_message(ByVal msg As String, ByVal location As String) As String
        Dim strRtn As String = ""
        strRtn = "<script language=JavaScript>" & vbCrLf
        strRtn += "alert('" + msg + "');" & vbCrLf
        strRtn += "</script>" & vbCrLf
        strRtn += "<script language=javascript> document.location.href='" + location + "';</script>" & vbCrLf
        Return strRtn
    End Function
End Class
