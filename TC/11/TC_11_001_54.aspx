<%@ Page AspCompat="true" Language="vb" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="TC_11_001_54.aspx.vb" Inherits="WDAIIP.TC_11_001_T54" %>
...
<body>
    <form id="form1" method="post" runat="server">
            ...
            <tr>
                <td align="center">
                    <table id="Table3" class="table_sch" cellpadding="1" cellspacing="1">
                        ...
                        <%--<tr id="tr_sch_ddlAPPSTAGE" runat="server"><td class="bluecol_need">申請階段</td>
                            <td class="whitecol"><asp:DropDownList ID="sch_ddlAPPSTAGE" runat="server"></asp:DropDownList></td></tr>--%>
                        <tr>
        ...
        <table id="FrameTableEdt2" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
            <tr>
                <td colspan="4" class="table_title" width="100%">申辦計畫班級資訊</td>
            </tr>
            <tr>
                <td class="bluecol" width="20%">訓練機構</td>
                <td class="whitecol" colspan="3" width="80%">
                    <asp:Label ID="lab_ORGNAME_1" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bluecol" width="20%">計畫年度 </td>
                <td class="whitecol" colspan="3" width="80%">
                    <asp:Label ID="lab_YEARS_1" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bluecol" width="20%">班級名稱</td>
                <td class="whitecol" colspan="3" width="80%">
                    <%--<asp:Label ID="Label1" runat="server"></asp:Label>--%>
                    <asp:CheckBoxList ID="CBL_CLASSNAME1S" runat="server">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem></asp:ListItem>
                    </asp:CheckBoxList>
                    <input id="CBL_CLASSNAME1S_hid" type="hidden" value="0" name="CBL_CLASSNAME1S_hid" runat="server" />
                </td>
            </tr>
            <tr>
                <td align="center" class="whitecol" colspan="4">
                    <asp:Button ID="BTN_BACK2" runat="server" Text="(不儲存)回上一步" CssClass="asp_button_M"></asp:Button>
                    <asp:Button ID="BTN_SAVENEXT2" runat="server" Text="儲存後進下一步" CssClass="asp_button_M"></asp:Button>
                </td>
            </tr>
        </table>
                ...
                <td align="center">
                    <table id="Table4" class="table_sch" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="whitecol" colspan="3">
                                <asp:Label ID="labCLASSNAME2S" runat="server"></asp:Label>
                            </td>
                        </tr>
