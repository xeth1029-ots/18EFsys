<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TC_10_002.aspx.vb" Inherits="WDAIIP.TC_10_002" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function chkSaveData1() {
            ...
            //var rblCATEGORY = document.getElementById('rblCATEGORY');
            var v_rblCATEGORY = getRBLValue("rblCATEGORY"); //取得 RadioButtonList 值 
            //var v2_rblCATEGORY = getRadioValue(document.form1.rblCATEGORY); //取得 RadioButtonList 值 
            //debugger;;
            ...
            if (SMEETDATE.value == '') { msg += '請選擇輸入 會議日期/時間-開始\n'; }
        ...
        <asp:Panel ID="panelEdit" runat="server">
            <table class="table_nw" cellspacing="1" cellpadding="1" width="100%">
                ...
                <tr>
                    <td class="bluecol_need">日期/時間</td>
                    <td colspan="3" class="whitecol">
                        <asp:TextBox ID="SMEETDATE" runat="server" Columns="20" MaxLength="11"></asp:TextBox>
                        <span runat="server">
                        ...
                        時：<asp:DropDownList ID="MM1" runat="server">
                        </asp:DropDownList>
                        分～ 
                        ...
                        分
                        <%--<asp:TextBox ID="FMEETDATE" runat="server" Columns="20"></asp:TextBox>
                        <span runat="server">
                ...
                <tr>
                    <td class="bluecol_need">會議地點</td>
                    <td colspan="3" class="whitecol">
                        <asp:TextBox ID="MEETPLACE" runat="server" MaxLength="200" Columns="66"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="bluecol">主席</td>
                    <td colspan="3" class="whitecol">
