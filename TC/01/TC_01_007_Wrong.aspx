...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TC_01_007_Wrong.aspx.vb" Inherits="WDAIIP.TC_01_007_Wrong" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>TC_01_007_Wrong</title>
...
<body>
    <form id="form1" method="post" runat="server">    
        <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" CssClass="font" AutoGenerateColumns="False" Width="100%" CellPadding="8">
