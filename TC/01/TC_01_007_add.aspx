<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="TC_01_007_add.aspx.vb" Inherits="WDAIIP.TC_01_007_add" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function sentName() {
            ...
            if (!TeachCName) { return false; }
            var strName = TeachCName.value;
            var i_strName_max_length = 20;
            ...
            } else if (strName.length > i_strName_max_length) {
                msg = '中文姓名不可超過' + i_strName_max_length.toString() + '個字!';
            }

            if (msg != '') {
                alert(msg);
            } else {
                window.open('../../common/Translation.aspx?&sn=teach&name=' + escape(strName) + '&field=TeachEName', "sch", 'width=830,height=450,top=200,left=450,location=0,status=0,menubar=0,scrollbars=1,resizable=0,scrollbars=0');
            }
        ...
        function PL_focusState() {
            //ForeColor
            //var msgX1 = "請優先填寫與課程相關之專業技術類證照，若無證照資訊請填寫「無」。";
            var hid_PLMsgX1 = document.getElementById("hid_PLMsgX1");
            var msgX1 = hid_PLMsgX1.value;
            var ProLicense = document.getElementById("ProLicense");
            if (ProLicense.value == msgX1) {
                ProLicense.value = "";
                ProLicense.style.color = "#000000";
            }
            else if (ProLicense.value == "") {
                ProLicense.value = msgX1;
                ProLicense.style.color = "#666666";
            }
        }
        ...
        function chkdata() {
            ...
            if (ExpUnit1.value == '') msg += '請輸入服務單位1\n';
            if (ExpYears1.value == '') msg += '請輸入年資的年1\n';
            if (ExpMonths1.value == '') msg += '請輸入年資的月1\n';
            if (Specialty1.value == '') msg += '請輸入專長1\n';
            ...
            if (birthday.value == '') {
                ...
                if (!checkDate(birthday.value)) msg = msg + '出生日期格式不正確!\n';
            }
            ...
            if (document.form1.WorkStatus.selectedIndex == '0') { msg = msg + '請選擇任職狀況!\n'; }
            ...
            if (checkMaxLen2(ProLicense.value, 200)) {
                msg += '【專業證照】長度不可超過200字元\n';
            }
            if (ProLicense.value == msgX1 || ProLicense.value == "") {
                msg += '請輸入 專業證照!\n';
            }
            if (msg != '') {
                window.alert(msg);
		...
		var parms = "[['KindEngage','" + KindEngage.value + "']]";      // 透過 selectControl 傳遞給 SQLMap 的年度查詢條件, 格式請參考 selectControl 定義說明
                ...
                <tr>
                    <td>
                        <%--<table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
							<tr>
								<td>首頁&gt;&gt;訓練機構管理&gt;&gt;基本資料設定設定&gt;&gt;師資資料維護
									<asp:Label ID="Proecess" runat="server" ForeColor="#990000"></asp:Label><font color="#000000">(<font face="新細明體"><font color="#ff0000">*</font>為必填欄位</font>)</font> </td>
							</tr>
						</table>--%>
                        <asp:Label ID="Proecess" runat="server" ForeColor="#990000" Visible="false"></asp:Label>
                        <%--加上面那行是因為Proecess在VB裡面有用到，把它隱藏起來這樣才不會執行錯誤--%>
                        <br>
                        <table class="table_sch" id="Table3" cellpadding="1" cellspacing="1" width="99%">
                            <tbody>
                                <tr>
                                    <td class="bluecol_need" style="width: 20%">計劃階層 </td>
                                    ...
                                    <td class="bluecol_need" style="width: 20%">講師代碼<br />
                                        (最多十碼) </td>
                                    <td class="whitecol" style="width: 30%">
                                        <asp:TextBox ID="TeacherID" runat="server" MaxLength="10" Width="40%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol_need">講師姓名 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="TeachCName" runat="server" MaxLength="20" Width="40%"></asp:TextBox>
                                        <input id="btnSchEng" onclick="sentName();" type="button" value="英譯">
                                    </td>
                                    <td class="bluecol">講師英文姓名 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="TeachEName" runat="server" MaxLength="30" Width="80%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="whitecol">
                                        <asp:TextBox ID="IDNO" runat="server" MaxLength="12"></asp:TextBox>
                                        <input id="Button3" type="button" value="載入" name="Button3" runat="server" class="button_b_S">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td id="Invest1_TD2" align="left" runat="server" class="whitecol">
                                        <asp:RadioButton ID="R1" runat="server"></asp:RadioButton><asp:DropDownList ID="IVID" runat="server">
                                        </asp:DropDownList>
                                        <br>
                                        <asp:RadioButton ID="R2" runat="server"></asp:RadioButton>
                                        <asp:TextBox ID="Invest1" runat="server" MaxLength="50" Width="40%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr id="TR1" runat="server">
                                    <td id="TD4" runat="server" class="bluecol_need">內外聘 </td>
                                    <td id="TD5" style="height: 12px" runat="server" class="whitecol">
                                    ...
                                    <td id="KindID_TD2" style="height: 12px" runat="server" class="whitecol">
                                        <asp:DropDownList ID="KindID" runat="server" Width="180px">
                                            <asp:ListItem Value="0">請選擇內外聘</asp:ListItem>
                                        </asp:DropDownList>
                                        <%--<FONT color="#cc66ff">說明</FONT>--%>
                                    </td>
                                </tr>
                                ...
                                <tr id="tr_techtype34" runat="server">
                                    <td class="bluecol_need">類別 </td>
                                    <td colspan="5" class="whitecol">
                                        <asp:CheckBox Style="z-index: 0" ID="cb_techtype3" runat="server" CssClass="font" Text="教師"></asp:CheckBox>
                                        <asp:CheckBox Style="z-index: 0" ID="cb_techtype4" runat="server" CssClass="font" Text="第二教師"></asp:CheckBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="whitecol">
                                        <asp:TextBox ID="SchoolName" runat="server" MaxLength="50" Width="40%"></asp:TextBox>
                                    </td>
                                    <td class="bluecol_need">科系名稱 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Department" runat="server" MaxLength="50" Width="40%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol_need">聯絡電話 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Phone" runat="server" MaxLength="20" Width="40%"></asp:TextBox>
                                    </td>
                                    <td class="bluecol">行動電話 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Mobile" runat="server" MaxLength="20" Width="40%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol">電子郵件 </td>
                                    <td colspan="3" class="whitecol">
                                        <asp:TextBox ID="Email" runat="server" MaxLength="64" Width="40%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3" class="whitecol">
                                        <input id="city_code" maxlength="3" name="city_code" runat="server">－
                                            <input id="AddressZIPB3" maxlength="3" name="AddressZIPB3" runat="server">
                                        <input id="hidAddressZIP6W" type="hidden" runat="server">
                                        <asp:Literal ID="Litcity_code" runat="server"></asp:Literal><%--郵遞區號查詢--%>
                                        <br>
                                        <asp:TextBox ID="TBCity" runat="server" onfocus="this.blur()" Width="25%"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="4" class="head_navy">服務單位資料 </td>
                                </tr>
                                <tr>
                                    <td class="bluecol_need">服務單位名稱 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="WorkOrg" runat="server" Width="60%"></asp:TextBox>
                                    </td>
                                    <td class="bluecol">年資 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="ExpYears" runat="server" Width="20%"></asp:TextBox>年
										<asp:DropDownList ID="ExpMonths" runat="server">
                                        </asp:DropDownList>
                                        個月 <font color="#ff0000">(請輸入數字)</font> </td>
                                </tr>
                                <tr class="whitecol">
                                    <td class="bluecol">服務部門 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="ServDept" runat="server" Width="60%"></asp:TextBox>
                                    </td>
                                    <td id="Invest2_TD1" runat="server" class="bluecol">職稱 </td>
                                    <td id="Invest2_TD2" runat="server" class="whitecol">
                                        <asp:TextBox ID="Invest2" runat="server" MaxLength="50"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol_need">服務單位電話 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="WorkPhone" runat="server" Width="60%"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="whitecol">
                                        <input id="city_code1" maxlength="3" runat="server">－<input id="WorkZIPB3" maxlength="3" runat="server">
                                        <input id="hidWorkZIP6W" type="hidden" runat="server" />
                                        <asp:Literal ID="Litcity_code1" runat="server"></asp:Literal><%--郵遞區號查詢--%>
                                        <br>
                                        <asp:TextBox ID="TBCity1" runat="server" onfocus="this.blur()" Width="25%"></asp:TextBox>
                                ...
                                <tr>
                                    <td class="bluecol">服務單位 </td>
                                    <td colspan="3" class="whitecol">
                                        <table class="font" border="0" width="99%">
                                            <tr>
                                                <td class="whitecol">
                                                    <asp:Label ID="star1" runat="server"><FONT color="#ff0000">*</FONT></asp:Label>1. </td>
                                                <td class="whitecol">
                                                    <asp:TextBox ID="ExpUnit1" runat="server" MaxLength="50" Width="100%"></asp:TextBox>
                                                </td>
                                                <td class="whitecol">，
													<asp:Label ID="star2" runat="server">
																<FONT color="#ff0000">*</FONT></asp:Label>年資 </td>
                                                <td class="whitecol" colspan="3">
                                                    <asp:TextBox ID="ExpYears1" runat="server" Width="40%" MaxLength="4"></asp:TextBox>年
													<asp:DropDownList ID="ExpMonths1" runat="server">
                                                    </asp:DropDownList>
                                                    個月 <font face="新細明體" color="#ff0000">
                                                        <br />
                                                        (年資請輸入數字)</font> </td>
                                            </tr>
                                            <tr>
                                                <td class="whitecol">2. </td>
                                                <td class="whitecol">
                                                    <asp:TextBox ID="ExpUnit2" runat="server" MaxLength="50" Width="100%"></asp:TextBox>
                                                </td>
                                                <td class="whitecol">，年資 </td>
                                                <td class="whitecol" colspan="3">
                                                    <asp:TextBox ID="ExpYears2" runat="server" Width="40%" MaxLength="4"></asp:TextBox>年
													<asp:DropDownList ID="ExpMonths2" runat="server">
                                                    </asp:DropDownList>
                                                    個月 </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="whitecol">
                                                    <asp:TextBox ID="ExpUnit3" runat="server" MaxLength="50" Width="100%"></asp:TextBox>
                                                </td>
                                                <td class="whitecol">，年資 </td>
                                                <td class="whitecol" colspan="3">
                                                    <asp:TextBox ID="ExpYears3" runat="server" Width="40%" MaxLength="4"></asp:TextBox>年
													<asp:DropDownList ID="ExpMonths3" runat="server">
                                                    </asp:DropDownList>
                                                    個月 </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="whitecol">
                                        <table class="whitecol" border="0" width="99%">
                                            <tr>
                                                <td>&nbsp;&nbsp;&nbsp; 1. </td>
                                                <td>
                                                    <asp:TextBox ID="ExpSDate1" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpSDate1','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                                <td>～ </td>
                                                <td>
                                                    <asp:TextBox ID="ExpEDate1" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpEDate1','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;&nbsp;&nbsp; 2. </td>
                                                <td>
                                                    <asp:TextBox ID="ExpSDate2" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpSDate2','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                                <td>～ </td>
                                                <td>
                                                    <asp:TextBox ID="ExpEDate2" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpEDate2','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;&nbsp;&nbsp; 3. </td>
                                                <td>
                                                    <asp:TextBox ID="ExpSDate3" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpSDate3','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                                <td>～ </td>
                                                <td>
                                                    <asp:TextBox ID="ExpEDate3" runat="server" Width="50%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ExpEDate3','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="bluecol">專長1
										<asp:Label ID="star3" runat="server">
													<FONT color="#ff0000">*</FONT></asp:Label>
                                    </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Specialty1" onblur="checkTextLength(this,250)" onkeyup="checkTextLength(this,250);" runat="server" Width="180px" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,250)" MaxLength="250"></asp:TextBox>
                                    </td>
                                    <td class="bluecol">專長2 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Specialty2" onblur="checkTextLength(this,100)" onkeyup="checkTextLength(this,100);" runat="server" Width="180px" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,100)" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol">專長3 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Specialty3" onblur="checkTextLength(this,100)" onkeyup="checkTextLength(this,100);" runat="server" Width="180px" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,100)" MaxLength="100"></asp:TextBox>
                                    </td>
                                    <td class="bluecol">專長4 </td>
                                    <td class="whitecol">
                                        <asp:TextBox ID="Specialty4" onblur="checkTextLength(this,100)" onkeyup="checkTextLength(this,100);" runat="server" Width="180px" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,100)" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol">專長5 </td>
                                    <td colspan="3" class="whitecol">
                                        <asp:TextBox ID="Specialty5" onblur="checkTextLength(this,100)" onkeyup="checkTextLength(this,100);" runat="server" Width="180px" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,100)" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol">譯著 </td>
                                    <td colspan="3" class="whitecol">
                                        <asp:TextBox ID="TransBook" onblur="checkTextLength(this,100)" onkeyup="checkTextLength(this,100);" runat="server" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,100)" Columns="50" MaxLength="100"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bluecol_need">專業證照 </td>
                                    <td colspan="3" class="whitecol">
                                        <asp:TextBox ID="ProLicense" onblur="checkTextLength(this,200)" onkeyup="checkTextLength(this,200);" runat="server" TextMode="MultiLine" Height="80px" onchange="checkTextLength(this,200)" Columns="50" MaxLength="200"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3" class="whitecol">
                                        ...
                                        <font color="#ff0000">※排課使用:若選[是]則【排課功能】的師資選單會顯示,若選[否]則不顯示!!</font> </td>
                                </tr>
                            </tbody>
                        </table>
