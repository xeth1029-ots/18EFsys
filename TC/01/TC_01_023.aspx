<%@ Page AspCompat="true" Language="vb" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="TC_01_023.aspx.vb" Inherits="WDAIIP.TC_01_023" %>
        ...
        <table class="table_nw" width="100%" cellpadding="1" cellspacing="1">
            <tr>
                ...
                <td class="whitecol">
                    ...
                    <input id="orgid_value" type="hidden" runat="server" name="orgid_value" />&nbsp;
            ...
            <tr>
                <td class="bluecol">環境編號</td>
                <td class="whitecol">
                    <asp:TextBox ID="RMTNO" runat="server" Width="20%" MaxLength="30"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="bluecol">環境名稱</td>
                <td class="whitecol">
                    <asp:TextBox ID="RMTNAME" runat="server" Width="25%" MaxLength="200"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="whitecol">
                    <div align="center">
                        ...
                        <asp:Button ID="BtnSearch1" Text="查詢" runat="server" CssClass="asp_button_M"></asp:Button>&nbsp;
                        <asp:Button ID="BtnAddNew1" Text="新增" runat="server" CausesValidation="False" CssClass="asp_button_M"></asp:Button>
                    </div>
                    <div align="center">
                ...
                <td align="center">
                    <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" CssClass="font" AutoGenerateColumns="False" AllowPaging="True" CellPadding="8">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="RMTNO" HeaderText="環境編號">
                                <HeaderStyle HorizontalAlign="Center" Width="11%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="RMTNAME" HeaderText="環境名稱">
                                <HeaderStyle HorizontalAlign="Center" Width="11%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="TEACHSOFT_N" HeaderText="教學軟體">
                                <HeaderStyle HorizontalAlign="Center" Width="20%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="TEACHDEVICE_N" HeaderText="教學設備">
                                <HeaderStyle HorizontalAlign="Center" Width="20%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Left"></ItemStyle>
                            </asp:BoundColumn>
