<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="main2.aspx.vb" Inherits="WDAIIP.main2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#form1").closest("h3").find("span#titlePath1").html("");
            $("#form1").closest("h3").find("span#titlePath2").html("");
        });
        */
    </script>
</head>
<body>
    <form id="form1" method="post" runat="server">
        <div class="wrap">
            <div class="index-chart" id="divChart" runat="server" visible="true">
                <div class="col-xs-12">
                    <div class="col-xs-4">
                        <iframe id="ifrm1" src="images/main2_pic1.jpg" runat="server" frameborder="0" style="height:400px; width:100%; z-index:100; position:relative;" marginwidth="0" marginheight="0"></iframe>
                    </div>
                    <div class="col-xs-4">
                        <iframe id="ifrm2" src="images/main2_pic2.jpg" runat="server" frameborder="0" style="height:400px; width:100%; z-index:100; position:relative;" marginwidth="0" marginheight="0"></iframe>
                    </div>
                    <div class="col-xs-4">
                        <iframe id="ifrm3" src="images/main2_pic3.jpg" runat="server" frameborder="0" style="height:400px; width:100%; z-index:100; position:relative;" marginwidth="0" marginheight="0"></iframe>
                    </div>
                </div>
            </div>
            <div class="index-info">
                <div class="col-xs-12">
                    <div class="col-xs-4">
                        <div class="theme-news">
                            ...
                            <asp:Button ID="btnMore1" runat="server" Text="more ..." CssClass="btn btn-news-more" Visible="false" />
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="theme-news">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:Button ID="btnMore2" runat="server" Text="more ..." CssClass="btn btn-news-more" Visible="false" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="theme-news">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:Button ID="btnMore3" runat="server" Text="more ..." CssClass="btn btn-news-more" Visible="false" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="theme-download">
                        <h3 class="theme-download-title"><i class="fa fa-download"></i>下載專區</h3>
                        <div class="table-responsive">
                        ...
                        <asp:Button ID="btnMore4" runat="server" Text="more ..." CssClass="btn btn-news-more" Visible="false" />
                    </div>
                </div>
                 <div class="col-xs-12">
                    <div class="theme-svsteaching">
                        <h3 class="theme-svsteaching-title"><i class="fa fa-download"></i>影音教學專區</h3>
                        <div class="table-responsive">
                        ...
                        <asp:Button ID="btnMore5" runat="server" Text="more ..." CssClass="btn btn-news-more" Visible="false" />
                    </div>
                </div>
