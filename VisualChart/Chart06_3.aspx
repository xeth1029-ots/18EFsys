<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Chart06_3.aspx.vb" Inherits="WDAIIP.Chart06_3" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //debugger;
            //自辦在職：指標3_參訓年齡/性別分佈
            createMFChartB_3('VisualChartB_3', vdata1, vdata2, vdata3);
