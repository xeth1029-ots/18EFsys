<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PS_01_002.aspx.vb" Inherits="WDAIIP.PS_01_002" %>
        ...
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;個人化設定&gt;&gt;我的常用表件</asp:Label>
                </td>
            </tr>
        </table>
                                ...
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" CssClass="font" AutoGenerateColumns="False" CellPadding="8">
                                    ...
                                    <Columns>
                                           <asp:TemplateColumn HeaderText="功能類型">
                                            <ItemStyle Width="15%" BackColor="#f1f9fc"></ItemStyle>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Button ID="btn_REDIRECT" CommandName="REDIRECT" runat="server" Text="前往" CssClass="asp_button_M"></asp:Button>&nbsp;
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid>
