...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents CityList As System.Web.UI.WebControls.Literal
    Protected WithEvents ZipList As System.Web.UI.WebControls.Literal
    Protected WithEvents QueryCityId As System.Web.UI.HtmlControls.HtmlInputHidden
...
#End Region
    ...
    Private Sub GetZipTable(ByVal strCityId As String)
        ...
        '-----------------------------------------------------------------------
        Dim strSql As String = "SELECT ZipCode ZIP_ID,ZipName ZIP_NAME FROM ID_ZIP  WHERE CTID='" & strCityId & "'"
        '-----------------------------------------------------------------------
