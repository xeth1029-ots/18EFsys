<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="eforgetPwd.aspx.vb" Inherits="WDAIIP.eforgetPwd" %>
                    ...
                    <div class="col-sm-6 col-md-offset-3">
                        <div class="login-bar">
                            <h3 class="loginTitleA">
                                <img src="/images/icon-arrow.svg" alt="項目符號" />忘記密碼</h3>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4 label-set" for="txtUserId"><span class="mark-red">＊</span>帳號</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox CssClass="form-control formbar-bg alert-info" ID="txtUserId" runat="server" placeholder="請輸入您的帳號" MaxLength="20" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4 label-set" for="txtUserIdno"><span class="mark-red">＊</span>身分證號碼</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox CssClass="form-control formbar-bg alert-info" ID="txtUserIdno" runat="server" placeholder="請輸入您的身分證號碼" MaxLength="20" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4 label-set" for="txtUserEMAIL"><span class="mark-red">＊</span>E-Mail</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox CssClass="form-control formbar-bg alert-info" ID="txtUserEMAIL" runat="server" placeholder="請輸入您的E-Mail" MaxLength="60" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="login-bottom-line">
                                    <asp:Button ID="bt_submit" runat="server" CssClass="btn btn-primary" Text="&nbsp;&nbsp;&nbsp;寄送密碼函&nbsp;&nbsp;&nbsp;" />
                                    &nbsp;
