...
''' <summary>產生圖型碼 </summary>
Partial Class writeCode1
    ...
    Protected Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Dim vc2 As Turbo.Commons.ValidateCode2 = New Turbo.Commons.ValidateCode2()
        Dim vCode As String = SessionModel.Instance().LoginValidateCode  '從 SessionModel 中取得已儲存的 vCode
        ...
        If Request("Audio") = "Y" Then
            ...
            stream = (New Turbo.Commons.ValidateCode2()).CreateValidateAudio(vCode, audioPath)
        ...
        Else
            Dim flag_NG3 As Boolean = False
            If Not flag_NG3 AndAlso Request("rand") Is Nothing Then flag_NG3 = True
            If Not flag_NG3 AndAlso Convert.ToString(Request("rand")).Length = 0 Then flag_NG3 = True
            If flag_NG3 Then
                If (Response.StatusCode <> 404) Then Response.StatusCode = 404
                Response.End()
                Return
            ...
            '輸出驗證碼圖型
            'vCode = SessionModel.Instance().LoginValidateCode
            stream = (New Turbo.Commons.ValidateCode2()).CreateValidateGraphic(vCode)
