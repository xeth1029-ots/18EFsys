<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_09_009_R.aspx.vb" Inherits="WDAIIP.SD_09_009_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_09_009_R</title>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="740" border="0">
        <tr>
            <td class="font">
                首頁&gt;&gt;學員動態管理&gt;&gt;教務報表管理&gt;&gt;<font color="#990000">列印獎懲</font><font color="#990000">明細表</font>
            </td>
        </tr>
        <tr>
            <td>
                <table class="table_sch" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="whitecol" colspan="3">
                            ...
                            <asp:Button ID="Button1" Style="display: none" runat="server" Text="Button1"></asp:Button>
