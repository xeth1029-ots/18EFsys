<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_11_005_add09.aspx.vb" Inherits="TIMS.SD_11_005_add09" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_11_005_add09</title>
    ...
    <script language="javascript">
        ...
        function insert_next() {
            if (window.confirm("是否繼續新增下一筆?")) {
                location.href = 'SD_11_005_add09.aspx?ProcessType=next&ocid=' + document.getElementById("Re_OCID").value + '&SOCID=' + document.getElementById("Re_SOCID").value + '&ID=' + document.getElementById("Re_ID").value;
            }
            else {
...
<body ms_positioning="FlowLayout">
    <form id="form1" method="post" runat="server">
        ...
        <input id="ProcessType" type="hidden" size="1" name="ProcessType" runat="server">
        <input id="Re_ID" type="hidden" size="1" name="Re_ID" runat="server">
                ...
                <td>
                    <table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;教務管理&gt;&gt;<FONT color="#990000">受訓學員訓後動態調查表</FONT></asp:Label>
                            </td>
                        </tr>
                        --%>
                        <tr>
                    ...
                    <table class="font" id="TableName" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr id="StdTr" runat="server">
                            <td width="10%" class="bluecol">學員</td>
                            <td colspan="3" class="td_light"><asp:DropDownList ID="SOCID" runat="server" AutoPostBack="True"></asp:DropDownList></td>
                        </tr>
                    </table>
                    <table class="font" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td class="bluecol"><font color="#ffffff"><strong>【一、學員部份:】</strong></font></td>
                        </tr>
                        <tr>
                            <td class="td_light">
                        ...
                        <tr>
                            <td class="td_light">
                                ...
                                <asp:RadioButtonList ID="Q6" runat="server" CssClass="font" RepeatDirection="Horizontal"
                                    Font-Size="X-Small">
                        ...
                        <tr>
                            <td class="td_light">
                                ...
                                <div>
                                    1.<asp:TextBox ID="Q10_1_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    2.<asp:TextBox ID="Q10_2_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    3.<asp:TextBox ID="Q10_3_Note" runat="server" Width="192px" MaxLength="100"></asp:TextBox>
                                </div>
                            </td>
                        </tr>
                    </table>
