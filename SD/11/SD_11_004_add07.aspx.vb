...
#End Region
        ...
        If Not IsPostBack Then
            ...
            'Dim dr As DataRow
            Dim dt As DataTable
            sql = " SELECT StudentID, CASE WHEN LEN(a.StudentID) = 12 THEN b.Name COLLATE CHINESE_TAIWAN_STROKE_CI_AS + '(' + SUBSTRING(a.StudentID, LEN(a.StudentID)-3, 3) + ')' ELSE b.Name COLLATE CHINESE_TAIWAN_STROKE_CI_AS + '(' + SUBSTRING(a.StudentID, LEN(a.StudentID)-2 , 2) + ')' END AS Name, a.SOCID "
            ...
            sqlstr = " SELECT b.studentid, c.name, b.StudStatus, b.RejectTDate1, b.RejectTDate2, "
            sqlstr += "       FORMAT(ISNULL(p.totalcost,0)/(CASE WHEN ISNULL(p.TNum, 1) <> 0 THEN ISNULL(p.TNum, 1) ELSE 1 END), '#######0.##') AS totalcost, "
            sqlstr += "       FORMAT(ISNULL(p.defstdcost,0)/(CASE WHEN ISNULL(p.TNum, 1) <> 0 THEN ISNULL(p.TNum, 1) ELSE 1 END), '#######0.##') AS defstdcost "
            ...
            End Select
            Label1.Text = row("totalcost").ToString
            Label2.Text = row("defstdcost").ToString
            ...
            End If
            If ProcessType.Value = "check" Then   '查詢
    ...
    Private Sub create(ByVal StrSOCID As String)
        ...
        If Not row_list Is Nothing Then
            ...
            If Not IsDBNull(row_list("Q9")) Then Q9.SelectedValue = row_list("Q9") Else Q9.SelectedIndex = -1
            If Not IsDBNull(row_list("Q9_Note")) Then Q9_Note.Text = row_list("Q9_Note") Else Q9_Note.Text = ""
        Else
    ...
    Function Check_Stud_QuestionFac() As Boolean
        ...
        If Q1_6_CHour.Text <> "" Then
            If Not IsNumeric(Q1_6_CHour.Text) Then msg += "訓練時數應增加必須為數字" & vbCrLf
        End If
        If Q1_6_MHour.Text <> "" Then
            If Not IsNumeric(Q1_6_MHour.Text) Then msg += "訓練時數應減少必須為數字" & vbCrLf
        End If
        If Q2_1_CHour.Text <> "" Then
            If Not IsNumeric(Q2_1_CHour.Text) Then msg += "術科時數應增加必須為數字" & vbCrLf
        End If
        If Q2_1_MHour.Text <> "" Then
            If Not IsNumeric(Q2_1_MHour.Text) Then msg += "術科時數應減少必須為數字" & vbCrLf
        End If
        If msg <> "" Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If Q9.SelectedIndex = -1 Then dr_row("Q9") = Convert.DBNull Else dr_row("Q9") = Q9.SelectedValue
            If Q9_Note.Text = "" Then dr_row("Q9_Note") = Convert.DBNull Else dr_row("Q9_Note") = Q9_Note.Text
