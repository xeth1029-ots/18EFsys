<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_11_004_add08.aspx.vb" Inherits="TIMS.SD_11_004_add08" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_11_004_add08</title>
    ...
    <script language="javascript">
        function ChkData() {
            ...
            */
            ...
            if (isEmpty('Q8')) { msg += '8.你對訓練單位的行政服務滿意度\n'; }
            if (isEmpty('Q9_1')) { msg += '9-1.瞭解補助對象\n'; }
            if (isEmpty('Q9_2')) { msg += '9-2.瞭解補助經費標準\n'; }
            if (isEmpty('Q9_3')) { msg += '9-3.瞭解補助流程\n'; }
            if (isEmpty('Q10')) { msg += '10.整體而言，你對於參加本計畫訓練的滿意度\n'; }
            if (msg == '') {
                return true;
            } else {
                msg = '請確認下列答案：\n' + msg;
        ...
        function insert_next() {
            if (window.confirm("是否繼續新增下一筆?")) {
                location.href = 'SD_11_004_add08.aspx?ProcessType=next&ocid=' + document.getElementById("Re_OCID").value + '&SOCID=' + document.getElementById("Re_SOCID").value + '&ID=' + document.getElementById("Re_ID").value;
            }
            else {
            ...
            <tr>
                <td>
                    <table id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label_Stud" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="Label_Name" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="Label_Status" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table id="TableName" cellspacing="1" cellpadding="1" width="100%" border="0">
                    ...
                    <table id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td bgcolor="#2aafc0"><font color="#ffffff">【第一部份：講授內容-6】</font></td>
                        </tr>
                        <tr bgcolor="#ecf7ff">
                            <td bgcolor="#ecf7ff">
                                <div><font color="#ffffff">&nbsp;&nbsp;&nbsp;</font><span class="style1"><strong>1. 課程內容與工作性質是否相關？</strong></span></div>
                                <div>
                                    <asp:RadioButtonList ID="Q1_1" runat="server" Width="584px" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td style="height: 65px" bgcolor="#ecf7ff">
                                <div>
                        ...
                        <tr bgcolor="#ecf7ff">
                            <td style="height: 54px" bgcolor="#ecf7ff">
                        ...
                        <tr bgcolor="#ecf7ff">
                            <td style="height: 135px" bgcolor="#ecf7ff">
                                <div><span class="style1">&nbsp;<strong> 6. 訓練時數是否適當？</strong></span></div>
                                <div><asp:RadioButton ID="Q1_61" runat="server" GroupName="Q1" Text="適當"></asp:RadioButton></div>
                                <div>
                                    <asp:RadioButton ID="Q1_62" runat="server" GroupName="Q1" Text="應增加(課程名稱)"></asp:RadioButton>
                                    <asp:TextBox ID="Q1_6_CCourName" runat="server" MaxLength="100"></asp:TextBox>&nbsp;增加
                                    <asp:TextBox ID="Q1_6_CHour" runat="server" MaxLength="5"></asp:TextBox>小時
                                </div>
                                <div>
                                    <asp:RadioButton ID="Q1_63" runat="server" GroupName="Q1" Text="應減少(課程名稱)"></asp:RadioButton>
                                    <asp:TextBox ID="Q1_6_MCourName" runat="server" MaxLength="100"></asp:TextBox>&nbsp;&nbsp;減少
                                    <asp:TextBox ID="Q1_6_MHour" runat="server" MaxLength="5"></asp:TextBox>小時
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第二部份：術科操作-5 (如無術科免填) 】</span></td>
                        </tr>
                        <tr bgcolor="#ecf7ff">
                            <td style="height: 135px" bgcolor="#ecf7ff">
                                <div><span class="style1">&nbsp;<strong> 1. 術科時數是否適當？</strong></span></div>
                                <div><asp:RadioButton ID="Q2_11" runat="server" GroupName="Q2" Text="適當"></asp:RadioButton></div>
                                <div>
                                    <asp:RadioButton ID="Q2_12" runat="server" GroupName="Q2" Height="12px" Text="應增加(課程名稱)"></asp:RadioButton>
                                    <asp:TextBox ID="Q2_1_CCourName" runat="server" Width="248px" MaxLength="100"></asp:TextBox>&nbsp; 增加
                                    <asp:TextBox ID="Q2_1_CHour" runat="server" Width="24px" MaxLength="5"></asp:TextBox>小時
                                </div>
                                <div>
                                    <asp:RadioButton ID="Q2_13" runat="server" GroupName="Q2" Height="28px" Text="應減少(課程名稱)"></asp:RadioButton>
                                    <asp:TextBox ID="Q2_1_MCourName" runat="server" Width="248px" MaxLength="100"></asp:TextBox>&nbsp;&nbsp;減少
                                    <asp:TextBox ID="Q2_1_MHour" runat="server" Width="24px" MaxLength="5"></asp:TextBox>小時
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q2_3" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q2_4" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td style="height: 65px" bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q2_5" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第三部份：講授人員-3】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                                <div>&nbsp;&nbsp; <strong>1. 教師的教學態度</strong></div>
                                <div>
                                    <asp:RadioButtonList ID="Q3_1" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q3_3" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1">非常適當</asp:ListItem>
                                        <asp:ListItem Value="2">適當</asp:ListItem>
                                        <asp:ListItem Value="3">尚可</asp:ListItem>
                                        <asp:ListItem Value="4">不適當</asp:ListItem>
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第四部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第五部份：】</span></td>
                        </tr>
                        <tr bgcolor="#ecf7ff">
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    ...
                                    <asp:TextBox ID="Q5_Note_News" runat="server" Width="140px" MaxLength="100"></asp:TextBox>
                                </div>
                                <div><asp:RadioButton ID="Q5_5" runat="server" Width="112px" GroupName="Q5" Height="20px" Text="服務單位"></asp:RadioButton>
                                    <asp:RadioButton ID="Q5_6" runat="server" Width="56px" GroupName="Q5" Height="20px" Text="其他"></asp:RadioButton>
                                    <asp:TextBox ID="Q5_Note_Other" runat="server" Width="168px" MaxLength="100"></asp:TextBox>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第六部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                                <div>
                                    &nbsp;&nbsp;&nbsp;<strong>訓練費用總共 </strong>
                                    <asp:Label ID="Label1" runat="server"></asp:Label><strong>元，其中自行繳納</strong>&nbsp;
                                    <asp:Label ID="Label2" runat="server"></asp:Label><strong>元。 
                                    除政府補助外，自行繳納費用負擔方式(可複選)</strong>
                                </div>
                                <div>
                                    <asp:CheckBox ID="Q6_1" runat="server" Width="72px" Height="23px" Text="自行負擔"></asp:CheckBox>
                                    <asp:TextBox ID="Q6_Note1" runat="server" Width="80px" MaxLength="100"></asp:TextBox>元&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:CheckBox ID="Q6_2" runat="server" Width="96px" Height="23px" Text="服務單位負擔"></asp:CheckBox>
                                    <asp:TextBox ID="Q6_Note2" runat="server" Width="80px" MaxLength="100"></asp:TextBox>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:CheckBox ID="Q6_3" runat="server" Width="80px" Height="24px" Text="兩者皆有"></asp:CheckBox>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第七部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第八部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                                <div>
                                    &nbsp;&nbsp; <strong>你對訓練單位的行政服務滿意度</strong>
                                </div>
                                <div>
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第九部份：你瞭解<asp:Label ID="Label4" runat="server"></asp:Label>規劃設計】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <strong>
                                        <asp:RadioButtonList ID="Q9_2" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="1">非常同意</asp:ListItem>
                                            <asp:ListItem Value="2">同意</asp:ListItem>
                                            <asp:ListItem Value="3">無意見</asp:ListItem>
                                            <asp:ListItem Value="4">不同意</asp:ListItem>
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第十部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                        ...
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第十一部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                                &nbsp;&nbsp; <strong>若無補助訓練計畫經費，你每年願意以自費參加相關訓練課程之金額
                                <asp:Label ID="Label3" runat="server"></asp:Label>
                                <asp:TextBox ID="Q11" runat="server" Width="80px" MaxLength="10"></asp:TextBox>元</strong>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#2aafc0"><span class="style2">【第十二部份：】</span></td>
                        </tr>
                        <tr>
                            <td bgcolor="#ecf7ff">
                                <strong>其他建議</strong>
                                <div><asp:TextBox ID="Q12" runat="server" Width="584px" Height="76px" TextMode="MultiLine" MaxLength="200"></asp:TextBox></div>
                            </td>
                        </tr>
                    </table>
                    <div align="center">
