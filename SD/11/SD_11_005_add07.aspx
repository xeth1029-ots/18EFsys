<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_11_005_add07.aspx.vb" Inherits="TIMS.SD_11_005_add07" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_11_005_add07</title>
    ...
    <script language="javascript">
        function ChkData() {
            ...
            if (isEmpty('Q7')) { msg += '請選擇 7.是否有繼續參與進修訓練的意願?\n'; }
            if (msg == '') {
                return true;
            } else {
                alert(msg);
        ...
        function insert_next() {
            if (window.confirm("是否繼續新增下一筆?")) {
                location.href = 'SD_11_005_add07.aspx?ProcessType=next&ocid=' + document.getElementById("Re_OCID").value + '&SOCID=' + document.getElementById("Re_SOCID").value + '&ID=' + document.getElementById("Re_ID").value;
            } else {
            ...
            <tr>
                <td>
                    ...
                    <table class="font" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr bgcolor="#ecf7ff">
                            <td bgcolor="#ecf7ff">
                                <div><span class="style1"><strong>6.學員認為參加訓練對目前的工作是否有幫助 ?</strong></span></div>
                                <asp:RadioButtonList ID="Q6" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                    <asp:ListItem Value="1">非常有幫助</asp:ListItem>
                                    <asp:ListItem Value="2">有些幫助</asp:ListItem>
                                    <asp:ListItem Value="3">尚可</asp:ListItem>
                                    <asp:ListItem Value="4">沒什麼幫助</asp:ListItem>
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                <div><span class="style1"><strong>8.學員認為還需要加強哪方面的專業知識使工作進行得更順利 ?</strong></span></div>
                                <div>
                                    1.<asp:TextBox ID="Q8_1_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    2.<asp:TextBox ID="Q8_2_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    3.<asp:TextBox ID="Q8_3_Note" runat="server" Width="192px" MaxLength="100"></asp:TextBox>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 65px" bgcolor="#ecf7ff">
                                <div><span class="style1"><strong>9.學員常和本課程的哪些學員、教師或職員聯絡 ?</strong></span></div>
                                <div>
                                    1.<asp:TextBox ID="Q9_1_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    2.<asp:TextBox ID="Q9_2_Note" runat="server" Width="176px" MaxLength="100"></asp:TextBox>
                                    3.<asp:TextBox ID="Q9_3_Note" runat="server" Width="192px" MaxLength="100"></asp:TextBox>
                                </div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="font" id="Table5" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            ...
                            <td bgcolor="#ecf7ff" colspan="3"><asp:TextBox ID="BusName" runat="server"></asp:TextBox></td>
                        </tr>
                    </table>
                    <table class="font" id="Table6" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q11" runat="server" CssClass="font" Width="584px" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td bgcolor="#ecf7ff">
                                ...
                                <div>
                                    <asp:RadioButtonList ID="Q12" runat="server" CssClass="font" Width="584px" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1">明顯提升</asp:ListItem>
                                        <asp:ListItem Value="2">略有提升</asp:ListItem>
                                        <asp:ListItem Value="3">沒有提升</asp:ListItem>
                                        <asp:ListItem Value="4">略有下降</asp:ListItem>
                    ...
                    <div align="center">
                        <asp:Button ID="Button1" runat="server" Width="41px" Text="儲存" CausesValidation="False"></asp:Button>
                        <asp:Button ID="Button2" runat="server" Text="回上一頁" CausesValidation="False"></asp:Button>
                        <asp:Button ID="next_but" runat="server" Text="不儲存填寫下一位" CausesValidation="False"></asp:Button>
                    </div>
