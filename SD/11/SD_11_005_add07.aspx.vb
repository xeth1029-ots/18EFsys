...
#End Region
        ...
        If Not IsPostBack Then
            ...
            Dim dr As DataRow
            Dim dt As DataTable
            sql = " SELECT StudentID, CASE WHEN LEN(a.StudentID) = 12 THEN b.Name COLLATE CHINESE_TAIWAN_STROKE_CI_AS + ISNULL('(' + SUBSTRING(a.StudentID,LEN(a.StudentID)-3,3) COLLATE CHINESE_TAIWAN_STROKE_CI_AS + ')', '') ELSE b.Name COLLATE CHINESE_TAIWAN_STROKE_CI_AS + ISNULL('(' + SUBSTRING(a.StudentID,LEN(a.StudentID)-2,2) COLLATE CHINESE_TAIWAN_STROKE_CI_AS + ')', '') END AS Name, a.SOCID "
            sql += " FROM (SELECT * FROM Class_StudentsOfClass WHERE OCID = @OCID) a "
    ...
    Private Sub create(ByVal StrSOCID As String)
        ...
        If Not row_list Is Nothing Then
            ...
            If Not IsDBNull(row_list("Q8_1_Note")) Then Q8_1_Note.Text = row_list("Q8_1_Note").ToString Else Q8_1_Note.Text = ""
            If Not IsDBNull(row_list("Q8_2_Note")) Then Q8_2_Note.Text = row_list("Q8_2_Note").ToString Else Q8_2_Note.Text = ""
            If Not IsDBNull(row_list("Q8_3_Note")) Then Q8_3_Note.Text = row_list("Q8_3_Note").ToString Else Q8_3_Note.Text = ""
            ...
            If Not IsDBNull(row_list("Q10")) Then Common.SetListItem(Q10, row_list("Q10"))
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If Q8_1_Note.Text = "" Then dr_row("Q8_1_Note") = Convert.DBNull Else dr_row("Q8_1_Note") = Q8_1_Note.Text
            If Q8_2_Note.Text = "" Then dr_row("Q8_2_Note") = Convert.DBNull Else dr_row("Q8_2_Note") = Q8_2_Note.Text
            If Q8_3_Note.Text = "" Then dr_row("Q8_3_Note") = Convert.DBNull Else dr_row("Q8_3_Note") = Q8_3_Note.Text
