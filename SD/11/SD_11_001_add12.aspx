<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_11_001_add12.aspx.vb" Inherits="WDAIIP.SD_11_001_add12" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function insert_next() {
            if (window.confirm("是否繼續新增下一筆?")) {
                location.href = document.getElementById("hPageUrl").value + '?ProcessType=Next&ocid=' + document.getElementById("Re_OCID").value + '&Stuedntid=' + document.getElementById("Re_Studentid").value + '&ID=' + document.getElementById("Re_ID").value;
            }
            else {
        ...
        function ChgFont(QType) {
            var TD_R5_INTXT = "【第五部份：證照與工作-4】";
            if (QType == 'B') { TD_R5_INTXT = "【第五部份：職訓與工作-4】"; }
            document.getElementById("TD_R5").innerText = TD_R5_INTXT;
        }
...
<body>
    ...
    <form id="form1" method="post" runat="server">
        ...
        <input id="hPageUrl" type="hidden" name="hPageUrl" runat="server">
        ...
        <input id="Qtype_Value" type="hidden" size="2" runat="server">
            ...
            <tr>
                <td>
                    <table class="font" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label1" runat="server" ForeColor="Red" Visible="False">問卷類型尚未設定，請聯絡系統管理員！！</asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table class="font" id="TableName" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr id="StdTr" runat="server">
                            <td class="bluecol" style="width: 20%">學員</td>
                            <td id="TD_Stud" colspan="3">
                    ...
                    <table class="font" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                        ...
                        <tr bgcolor="#ecf7ff">
                            <td id="TD_R1_1" class="whitecol" runat="server">
                                <div>
                                    <asp:Label ID="Label_R1_1" runat="server">  1. 請問您這次參加的職訓課程，對課程內容安排及銜接是否滿意？</asp:Label>
                                </div>
                                <div>
                                ...
                                <asp:RequiredFieldValidator ID="Re_R1_1" runat="server" ErrorMessage="請選擇第一部分的問題一" Display="None" ControlToValidate="RadioButtonList1_1"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R1_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R1_2" runat="server">   2. 請問您這次參加的職訓課程，對課程時數安排是否滿意？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <asp:RequiredFieldValidator ID="Re_R1_2" runat="server" ErrorMessage="請選擇第一部分的問題二" Display="None" ControlToValidate="RadioButtonList1_2"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R1_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R1_3" runat="server">3.請問您這次參加的職訓課程，對使用的上課教材與訓練設施（如工具 /材料）是否滿意？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R1_3" runat="server" ErrorMessage="請選擇第一部分的問題三" Display="None" ControlToValidate="RadioButtonList1_3"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td id="TD_R2_1" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R2_1" runat="server" Width="512px"> 1.請問您滿不滿意老師專業知識？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R2_1" runat="server" ErrorMessage="請選擇第二部分的問題一" Display="None" ControlToValidate="RadioButtonList2_1"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R2_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R2_2" runat="server">2.請問您滿不滿意老師教學態度及 教學耐心 ？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R2_2" runat="server" ErrorMessage="請選擇第二部分的問題二" Display="None" ControlToValidate="RadioButtonList2_2"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R2_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R2_3" runat="server">3.  請問您滿不滿意老師實務操作之教導能力？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R2_3" runat="server" ErrorMessage="請選擇第二部分的問題三" Display="None" ControlToValidate="RadioButtonList2_3"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R2_4" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R2_4" runat="server">4.請問您滿不滿意老師與學員間之互動？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R2_4" runat="server" ErrorMessage="請選擇第二部分的問題四" Display="None" ControlToValidate="RadioButtonList2_4"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R2_5" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R2_5" runat="server">5. 請問您對老師教學準備工作是否滿意？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R2_5" runat="server" ErrorMessage="請選擇第二部分的問題五" Display="None" ControlToValidate="RadioButtonList2_5"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="bluecol" id="TD_R3">【第三部份：學習環境與行政支援-3】</td>
                        </tr>
                        <tr>
                            <td id="TD_R3_1" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_1" runat="server">1.  請問您滿不滿意訓練單位的上課環境？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R3_1" runat="server" ErrorMessage="請選擇第三部分的問題一" Display="None" ControlToValidate="RadioButtonList3_1"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R3_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_2" runat="server">2.請問您這次參加的職訓課程，對訓練單位公共安全(如無障礙設施）是否滿意？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R3_2" runat="server" ErrorMessage="請選擇第三部分的問題二" Display="None" ControlToValidate="RadioButtonList3_2"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R3_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_3" runat="server">3.請問您對訓練單位行政支援（如求助導師及申訴管道）是否滿意？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R3_3" runat="server" ErrorMessage="請選擇第三部分的問題三" Display="None" ControlToValidate="RadioButtonList3_3"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R3_4" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_4" runat="server">4.  請問您參加職訓的機構有提供就業輔導嗎？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R3_4" runat="server" ErrorMessage="請選擇第三部分的問題四" Display="None" ControlToValidate="RadioButtonList3_4"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R3_5" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_5" runat="server">5.  那您滿不滿意其提供就業輔導服務？ (針對第四題回答有者) </asp:Label>
                                </div>
                                <div>
                        ...
                        <tr>
                            <td id="TD_R3_6" runat="server" class="whitecol">
                                <div>6.<asp:Label ID="Label_R3_6" runat="server">請問您這次參加的職訓課程，對訓練單位提供就業資訊是否滿意？(針對第四題回答有者) </asp:Label></div>
                                <div>
                                    <asp:RadioButtonList ID="RadioButtonList3_6" runat="server" CssClass="font" Width="584px" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1">非常滿意</asp:ListItem>
                                        <asp:ListItem Value="2">滿意</asp:ListItem>
                                        <asp:ListItem Value="3">普通</asp:ListItem>
                                        <asp:ListItem Value="4">不滿意</asp:ListItem>
                        ...
                        <tr>
                            <td id="TD_R3_7" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R3_7" runat="server">7.請問您這次參加的職訓課程，對訓練單位提供就業推介服務是否滿意？(針對第四題回答有者)</asp:Label>
                                </div>
                                <div>
                        ...
                        <tr>
                            <td id="TD_R4_1" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_1" runat="server">1.  請問您覺得自己上課內容吸收程度如何？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_1" runat="server" ErrorMessage="請選擇第四部分的問題一" Display="None" ControlToValidate="RadioButtonList4_1"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R4_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_2" runat="server">2.  您對於自己職訓這段期間表現打幾分？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_2" runat="server" ErrorMessage="請選擇第四部分的問題二" Display="None" ControlToValidate="RadioButtonList4_2"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R4_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_3" runat="server">3.  請問若用考試評估您的學習效果，您的學習效果如何？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_3" runat="server" ErrorMessage="請選擇第四部分的問題三" Display="None" ControlToValidate="RadioButtonList4_3"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R4_4" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_4" runat="server">4.  請問若用交作業評估您的學習效果，您的學習效果如何？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_4" runat="server" ErrorMessage="請選擇第四部分的問題四" Display="None" ControlToValidate="RadioButtonList4_4"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R4_5" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_5" runat="server">5.  請問若用實習評估您的學習效果，您的學習效果如何？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_5" runat="server" ErrorMessage="請選擇第四部分的問題五" Display="None" ControlToValidate="RadioButtonList4_5"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R4_6" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R4_6" runat="server">6. 請問您受訓前的期待與受訓後的感受有沒有落差？感受如何？</asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R4_6" runat="server" ErrorMessage="請選擇第四部分的問題六" Display="None" ControlToValidate="RadioButtonList4_6"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td id="TD_R5_1" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R5_1" runat="server">1.  請問您參加此職訓的目的之一是不是要考證照？ </asp:Label>
                                </div>
                                <div>
                                    <asp:RadioButtonList ID="RadioButtonList5_1" runat="server" CssClass="font" Width="584px" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="1">是</asp:ListItem>
                                        <asp:ListItem Value="2">不是</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R5_1" runat="server" ErrorMessage="請選擇第五部分的問題一" Display="None" ControlToValidate="RadioButtonList5_1"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R5_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R5_2" runat="server">2.  請問您這次參加的職訓課程， 對您的證照考試幫助大不大？</asp:Label>
                                </div>
                                <div>
                                ...
                                <asp:RequiredFieldValidator ID="Re_R5_2" runat="server" ErrorMessage="請選擇第五部分的問題二" Display="None" ControlToValidate="RadioButtonList5_2"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R5_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R5_3" runat="server">3.  請問您這次參加的職訓課程， 有沒有考到證照？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <asp:RequiredFieldValidator ID="Re_R5_3" runat="server" ErrorMessage="請選擇第五部分的問題三" Display="None" ControlToValidate="RadioButtonList5_3"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R5_4" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R5_4" runat="server">4.  考到證照後，對找工作有沒有幫助 ？(針對上一題回答有者) </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R5_4" runat="server" ErrorMessage="請選擇第五部分的問題四" Display="None" ControlToValidate="RadioButtonList5_4"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td id="TD_R6_1" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R6_1" runat="server">1.  受訓所學知識技能，對找工作有沒有幫助？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R6_1" runat="server" ErrorMessage="請選擇第六部分的問題一" Display="None" ControlToValidate="RadioButtonList6_1"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R6_2" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R6_2" runat="server">2.  受訓頒發的結業證書，對找工作有沒有幫助？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R6_2" runat="server" ErrorMessage="請選擇第六部分的問題二" Display="None" ControlToValidate="RadioButtonList6_2"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R6_3" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R6_3" runat="server">3.  老師名氣，對找工作有沒有幫助？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R6_3" runat="server" ErrorMessage="請選擇第六部分的問題三" Display="None" ControlToValidate="RadioButtonList6_3"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td id="TD_R6_4" runat="server" class="whitecol">
                                <div>
                                    <asp:Label ID="Label_R6_4" runat="server">4.  職訓機構名聲，對找工作有沒有幫助？ </asp:Label>
                                </div>
                                <div>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="Re_R6_4" runat="server" ErrorMessage="請選擇第六部分的問題四" Display="None" ControlToValidate="RadioButtonList6_4"></asp:RequiredFieldValidator>
                                </div>
                            </td>
                        </tr>
                    </table>
                    <div align="center" class="whitecol">
                        <%--onclick="history.back(); location.reload();" --%>
                        ...
                        <input id="Button2" type="button" value="回上頁" name="Button2" runat="server" class="asp_button_M" onclick="BAK();" />
