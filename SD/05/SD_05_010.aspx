<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="SD_05_010.aspx.vb" Inherits="WDAIIP.SD_05_010" EnableEventValidation="false" %>
        ...
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;教務管理&gt;&gt;學員參訓歷史</asp:Label>
                </td>
            </tr>
        </table>
                        ...
                        <table class="table_nw" cellspacing="1" cellpadding="1" width="100%">
                            ...
                            <tr id="tr01c" runat="server">
                                ...
                                <td class="whitecol" colspan="3">
                                    ...
                                    <input id="RIDValue" type="hidden" runat="server"><input id="Button3" onclick="javascript: wopen('../../Common/MainOrg.aspx?DistID=' + document.form1.DistID.value + '&amp;TPlanID=' + document.form1.TPlanID.value, '訓練機構', 600, 500, 1)" type="button" value="..." name="Button3" runat="server" class="button_b_Mini">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="tr02d" runat="server">
                                ...
                                <td class="whitecol" colspan="3">
                                    ...
                                    <asp:Button ID="Button13" runat="server" Text="查詢匯入資料" CssClass="asp_button_M"></asp:Button>(必須為csv或ods格式)
								 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="../../Doc/StudIDNOHis_v21.zip" CssClass="font" ForeColor="#8080FF">下載整批上載格式檔</asp:HyperLink>
                                </td>
                            </tr>
