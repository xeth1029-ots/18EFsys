<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_05_004_add3.aspx.vb" Inherits="WDAIIP.SD_05_004_add3" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        function ShowOrg(vStatus) {
            //'RTReasonID'
            /*	04.患病或遇意外傷害	03.遇家庭等災變事故	07.自願、接受徵集入營者	31.工作異動	32.課程內容不符預期	01.缺課時數超過規定	99.其他	13.參訓期間行為不檢情節重大	33.身分不符	99.其他	*/
            ...
            if (HidRTReasonID && HidRTReasonID.value == '02') {
                if (trOrgData1) { trOrgData1.style.display = 'inline'; }
            }
        }
        ...
        function choose_class() { openClass('../02/SD_02_ch.aspx?special=2'); }
        ...
        function chkdata() {
            ...
            if (rtother == 'Y2' && RTReasoOther2.value == '') { msg += '離訓原因選擇其他說明必填，請輸入\n'; }
            if (rtother == 'Y3' && RTReasoOther3.value == '') { msg += '退訓原因選擇其他說明必填，請輸入\n'; }
                    ...
                    <table class="table_sch" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td class="whitecol" width="30%">
                                <asp:DropDownList ID="SOCID" runat="server"></asp:DropDownList><asp:Label ID="labSTDTURNOUT" runat="server" Text="(系統計算實際參訓時數)"></asp:Label>
                                <input id="SLTID" type="hidden" runat="server" />
                            </td>
                            <td class="bluecol_need" width="20%">離退訓日期 </td>
                            <td class="whitecol" width="30%">
                        ...
                        <%--<tr id="trRejectDayIn14" runat="server">
                            <td class="bluecol_need" width="20%">遞補期限內離退訓 </td>
                            <td colspan="3" class="whitecol">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                <asp:RadioButtonList ID="RTReasonID2" runat="server" Width="100%" CssClass="font" RepeatDirection="Horizontal" RepeatColumns="4">
                                </asp:RadioButtonList>
                                <asp:TextBox ID="RTReasoOther2" runat="server" MaxLength="100" Width="40%"></asp:TextBox>(若選其他，其他說明為必填。)<br>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                ...
                                <asp:TextBox ID="RTReasoOther3" runat="server" MaxLength="100" Width="40%"></asp:TextBox>(若選其他，其他說明為必填。)<br>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <table class="table_nw" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td colspan="3" class="whitecol">
                                            <asp:TextBox ID="JobDate" runat="server" Columns="20" MaxLength="12"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="whitecol">
                                            <asp:TextBox ID="JobOrgName" runat="server" Columns="40" MaxLength="100" Width="50%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">勞保証字號 </td>
                                        <td colspan="3" class="whitecol">
                                            <asp:TextBox ID="BusGNO" runat="server" MaxLength="30" Columns="30"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3" class="whitecol">
                                            ...
                                            <input id="btnGetZip" runat="server" onclick="getZip('../../js/Openwin/zipcode.aspx', 'JobCity', 'JobZipCode')" type="button" value="..." name="btnGetZip" class="button_b_Mini" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol" colspan="3">
                                            <asp:TextBox ID="JobTel" runat="server" Columns="30"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">事業單位傳真 </td>
                                        <td class="whitecol" colspan="3">
                                            <asp:TextBox ID="BusFax" runat="server" Columns="30"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">職稱 </td>
                                        <td colspan="3" class="whitecol">
                                            <asp:TextBox ID="BusTitle" runat="server" Columns="40"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3" class="whitecol">
                                            ...
                                            <table class="font" id="MemoTable" onmouseover="document.getElementById('MemoTable').style.display='inline';" style="display: none; border-collapse: collapse" onmouseout="document.getElementById('MemoTable').style.display='none';" cellspacing="0" cellpadding="1" width="400" bgcolor="lemonchiffon" border="1">
                                                <tr>
                                    ...
                                    <tr id="JobCode5" runat="server">
                                        <td class="bluecol">特殊屬性訓練班次<br />
                                            結訓學員就業<br />
                                            追蹤情形說明 </td>
                                        <td colspan="3" class="whitecol"><font onmouseover="document.getElementById('MemoTable').style.display='inline';" style="cursor: pointer" onmouseout="document.getElementById('MemoTable').style.display='none';" color="blue">有關「特殊屬性」說明</font>
                                            <br>
                        ...
                        <tr>
                            <td class="bluecol_need">實際參訓時數<br />
                                ...
                                受訓證明書) </td>
                            <td colspan="3" class="whitecol">
                                <asp:TextBox ID="TrainHours" runat="server" Columns="5" Width="30%"></asp:TextBox>
                                <asp:Label ID="LabTHours" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <%--<tr>
                        ...
                        <tr>
                            <td class="bluecol" width="20%">應賠金額 </td>
                            <td class="whitecol" width="30%">
                                <asp:TextBox ID="SumOfPay" runat="server" MaxLength="8" Width="50%"></asp:TextBox>
                                <input id="SumOfPay1" type="hidden" runat="server">
                            </td>
                            <td class="bluecol" width="20%">已賠金額 </td>
                            <td class="whitecol" width="30%">
                                <asp:TextBox ID="HadPay" runat="server" MaxLength="8" Width="50%"></asp:TextBox>
                            </td>
                        </tr>
