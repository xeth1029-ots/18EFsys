<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_05_005_R.aspx.vb" Inherits="WDAIIP.SD_05_005_R" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Set_FrameHeight(hh) {
            ...
            for (i = 0; i < parseInt(document.getElementById('WaterPage').value); i++) {
                document.body.innerHTML = document.body.innerHTML + "<IMG src='../../images/rptpic/temple/TIMS_2.jpg' style='z-index:-1;position:absolute;top:" + (i * 595) + "px;left:0px;;;display:inline' />";
            }
...
<body background="../../images/rptpic/temple/TIMS_1.jpg">
    <form id="form1" method="post" runat="server">
        <table id="tb_01" align="right">
            <tr>
                <td align="right">
                    <input id="doPrint" style="width: 24px; height: 22px" type="hidden" runat="server"><input id="WaterPage" style="width: 24px; height: 22px" type="hidden" name="WaterPage" runat="server"><asp:LinkButton ID="lb_print" runat="server"></asp:LinkButton><asp:ImageButton ID="bt_first" runat="server" ImageUrl="../../images/rptpic/First_Disabled.gif" Visible="False"></asp:ImageButton>&nbsp;&nbsp;<asp:ImageButton ID="bt_pre" runat="server" ImageUrl="../../images/rptpic/Previous_Disabled.gif" Visible="False"></asp:ImageButton>&nbsp;&nbsp;
				<asp:TextBox ID="tb_Page" runat="server" Visible="False" onfocus="this.blur()" Width="40px"></asp:TextBox>&nbsp;
				<asp:TextBox ID="tb_PageTotal" runat="server" Visible="False" onfocus="this.blur()" Width="40px"></asp:TextBox>&nbsp;<asp:ImageButton ID="bt_next" runat="server" ImageUrl="../../images/rptpic/Next_Disabled.gif" Visible="False"></asp:ImageButton>&nbsp;
				<asp:ImageButton ID="bt_end" runat="server" ImageUrl="../../images/rptpic/Last_Disabled.gif" Visible="False"></asp:ImageButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img id="printRpt" onclick="Auto_Print();" alt="列印報表" src="../../images/rptpic/Print.gif">&nbsp;&nbsp;<asp:ImageButton ID="bt_excel" runat="server" ImageUrl="../../images/rptpic/Excel.gif" Visible="False" AlternateText="匯出Excel"></asp:ImageButton>&nbsp;
                </td>
            </tr>
            <tr>
                <td>
        ...
        <!---print    start-->
        <div id="print_content" align="left" runat="server">
        </div>
        <!---print    end-->
        <font face="新細明體"></font>
