Partial Class SD_10_002_R
    Inherits AuthBasePage

    Const cst_printFN1 As String = "in_class" '套印受訓證明
    'Const cst_printFN2 As String = "inclass_16"
    'in_class
    ...
    Sub CCreate1()
        ...
        '受訓'證明字號
        ProveNum.Text = TIMS.GetGlobalVar(Me, "10", "1", objconn)
    ...
    Private Sub search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles search.Click
        ...
        parms.Add("OCIDV1", OCIDValue1.Value)

        Dim sql As String = ""
        sql = "" & vbCrLf
        sql &= " SELECT b.StudentID,c.name,c.EngName" & vbCrLf
        sql &= " ,b.OCID" & vbCrLf
        sql &= " ,b.StudStatus" & vbCrLf
        ...
        sql &= " AND b.STUDSTATUS NOT IN (2,3)" & vbCrLf
    ...
    Private Sub submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles submit.Click
        ...
        Dim objDG As DataGrid = Me.DG_stud
