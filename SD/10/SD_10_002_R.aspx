<%@ Page AspCompat="true" Language="vb" AutoEventWireup="false" CodeBehind="SD_10_002_R.aspx.vb" Inherits="WDAIIP.SD_10_002_R" %>
...
<head>
    ...
    <script type="text/javascript">
        function search1() {
            ...
            if (document.form1.ProveNum.value == '') msg += '請輸入 受訓證明字號\n';
        ...
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;證書及證明管理&gt;&gt;套印受訓證明書</asp:Label>
                </td>
            </tr>
        </table>
