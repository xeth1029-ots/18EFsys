<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_01_001_sch.aspx.vb" Inherits="WDAIIP.SD_01_001_sch" %>
                    ...
                    <table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td colspan="2">
                                <table class="font" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr>
                                        <td width="16%" class="bluecol">姓名：<asp:Label ID="labNAME" runat="server"></asp:Label></td>
                                        <td width="20%" class="bluecol">身分證號：<asp:Label ID="labIDNO" runat="server"></asp:Label></td>
                                        <td width="64%" class="whitecol">
                                            <asp:Button ID="btnPrint" runat="server" Text="列印" OnClientClick="window.print();return false;" CssClass="asp_Export_M"></asp:Button></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
						...
						<td colspan="2">
							<table class="table_sch" id="Table3">
								<tr>
									<td width="10%" rowspan="6" class="bluecol_left"><center>就服中心</center></td>
									<td class="whitecol">輔導就業狀況：<asp:Label ID="WorkState" runat="server"></asp:Label></td>
								</tr>
								<tr>
									<td class="whitecol">廠商名稱：<asp:Label ID="COMPNAME" runat="server"></asp:Label></td>
								</tr>
								<tr>
									<td class="whitecol">地址：<asp:Label ID="COMPADDR" runat="server"></asp:Label></td>
								</tr>
								<tr>
									<td class="whitecol">電話：<asp:Label ID="CONTEL" runat="server"></asp:Label></td>
								</tr>
								<tr>
									<td class="whitecol">錄用月薪：<asp:Label ID="REPLY_SALARY" runat="server"></asp:Label></td>
								</tr>
								<tr>
									<td class="whitecol">就業日期：<asp:Label ID="REPLY_WKDATE" runat="server"></asp:Label></td>
								</tr>
							</table>
						</td>
					</tr>--%>
                        <tr>
                            <td colspan="2">
                                <table class="font" id="Table5" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr>
                                        <td width="10%" class="bluecol">勞保局資料</td>
                                        <td align="center">
                                            <%--<asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="font" BorderWidth="1px" BorderColor="Silver">--%>
                                            <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="font" CellPadding="8">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="MDate" HeaderText="異動日期"></asp:BoundColumn>
                                                    ...
                                                    <asp:BoundColumn DataField="Salary" HeaderText="投保薪資級距"></asp:BoundColumn>
