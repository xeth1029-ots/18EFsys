<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_08_003_Reason.aspx.vb" Inherits="WDAIIP.SD_08_003_Reason" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_08_003_Reason</title>
    ...
    <script>
        function ReturnMyValue(MyValue, MyText) {
            parent.document.getElementById(getParamValue('ValueField')).value = MyValue;
            parent.document.getElementById(getParamValue('TextField')).value = MyText;
...
<body topmargin="2" leftmargin="2" onmouseover="ReStartSec();" onmouseout="HidFrame();">
    <form id="form1" method="post" runat="server">
        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" ShowHeader="False" Width="100%"
            ...
            <Columns>
                <asp:BoundColumn DataField="LRName"></asp:BoundColumn>
            </Columns>
        </asp:DataGrid>
    </form>
</body>
