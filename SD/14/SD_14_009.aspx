<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_009.aspx.vb" Inherits="WDAIIP.SD_14_009" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>參訓學員出席紀錄一覽表</title>
    ...
    <script type="text/javascript" language="javascript">
		...
		if (document.getElementById('Years').value >= 101) {
		//openPrint('../../SQControl.aspx?SQ_AutoLogout=true&sys=BussinessTrain&filename=SD_14_009&path=' + SMpath + '&Years=' + document.getElementById('Years').value + '&OCID=' + document.getElementById('OCIDValue1').value, '', '');
		openPrint('../../SQControl.aspx?filename=SD_14_009&path=' + SMpath + '&Years=' + document.getElementById('Years').value + '&OCID=' + document.getElementById('OCIDValue1').value, '', '');
		}
		else {
		//openPrint('../../SQControl.aspx?SQ_AutoLogout=true&sys=BussinessTrain&filename=SD_14_009_00&path=' + SMpath + '&Years=' + document.getElementById('Years').value + '&OCID=' + document.getElementById('OCIDValue1').value, '', '');
		openPrint('../../SQControl.aspx?filename=SD_14_009_00&path=' + SMpath + '&Years=' + document.getElementById('Years').value + '&OCID=' + document.getElementById('OCIDValue1').value, '', '');
		}
		}
		}
		*/
                    ...
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;參訓學員出席紀錄一覽表</asp:Label>
                            </td>
                        </tr>
                    </table>
