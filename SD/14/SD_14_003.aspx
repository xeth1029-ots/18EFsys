<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_003.aspx.vb" Inherits="WDAIIP.SD_14_003" %>
...
<body>
    <form id="form1" method="post" runat="server">
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;訓練機構管理&gt;&gt;表單列印&gt;&gt;訓練計畫總表</asp:Label>
                </td>
            </tr>
        </table>
                                ...
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" CssClass="font" AutoGenerateColumns="False" AllowPaging="True" CellPadding="8">
                                    ...
                                    <Columns>
                                        <asp:TemplateColumn HeaderStyle-Width="5%">
                                            ...
                                            <ItemTemplate>
                                                <input id="chkbox1" type="checkbox" runat="server" />
                                                <input id="PCSValue" type="hidden" runat="server" />
                                        ...
                                        <asp:BoundColumn DataField="STDate" HeaderText="開訓日期" HeaderStyle-Width="10%"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="FTDate" HeaderText="結訓日期" HeaderStyle-Width="10%"></asp:BoundColumn>
                                    </Columns>
        ...
        <asp:HiddenField ID="Hid_PlanID1" runat="server" />
        <asp:HiddenField ID="Hid_PCSVALUE" runat="server" />
        <asp:HiddenField ID="Hid_OCIDValue" runat="server" />
    </form>
</body>
</html>
