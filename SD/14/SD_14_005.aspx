<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_005.aspx.vb" Inherits="WDAIIP.SD_14_005" %>
                    ...
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;學員資料表</asp:Label>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table id="DataGridTable" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                        ...
                        <tr>
                            <td align="center" class="whitecol">
                                <%--<input id="Button3" type="button" value="列印" name="Button3" runat="server" class="asp_button_S">--%>
