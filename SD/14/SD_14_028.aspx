<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_028.aspx.vb" Inherits="WDAIIP.SD_14_028" %>
    ...
    <form id="form1" runat="server">
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;學員線上簽到(退)紀錄表</asp:Label>
                </td>
            </tr>
        </table>
        <table class="table_sch">
            ...
            <tr>
                ...
                <td class="whitecol" colspan="3">
                    <asp:TextBox ID="SCH_STRAINDATE" runat="server" Columns="10" Width="15%"></asp:TextBox>
                    <span runat="server">
                        <img style="cursor: pointer" onclick="javascript:show_calendar('SCH_STRAINDATE','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30"></span>
                </td>
            </tr>
        </table>
