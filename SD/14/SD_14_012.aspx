<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_012.aspx.vb" Inherits="WDAIIP.SD_14_012" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>支付參訓學員補助經費申請表</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CheckPrint() {
            ...
            for (i = 1; i < MyTable.rows.length; i++) {
                ...
                if (MyTable.rows[i].cells[0].children[0].checked) {
                    SelectItem(true, MyTable.rows[i].cells[0].children[0].value);
                }
            }
        ...
        function printkind() {
            ...
            if (getValue("print_type") == '2') {
                print_orderyby.value = 'c.StudentID'
            }
        }
        */
        ...
        function SelectItem(Flag, MyValue) {
            ...
            if (Flag) {
                ...
                if (SelectValue.value.indexOf(MyValue) != -1)
                    SelectValue.value = SelectValue.value.replace(MyValue, '')
                if (SelectValue.value.indexOf(',' + ',') != -1)
                    SelectValue.value = SelectValue.value.replace(',' + ',', ',')
            }
        }
    </script>
</head>
<body>
    <form id="form1" method="post" runat="server">
            ...
            <tr>
                <td>
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;支付參訓學員補助經費申請表</asp:Label>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div align="center" class="whitecol">
                        ...
                        <input id="printall" type="button" value="列印機構所有班級" runat="server" class="asp_button_M">
                    </div>
                    <div align="center">
                    ...
                    <table id="DataGridTable" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                        ...
                        <tr>
                            <td align="center">
                                <asp:RadioButtonList ID="print_type" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="font">
                        ...
                        <tr>
                            <td align="center" class="whitecol">
                                <%--<input id="Button5" type="button" value="列印" runat="server" class="asp_button_S" onclick="return Button5_onclick()">--%>
                                <asp:Button ID="Button5" runat="server" Text="列印" CssClass="asp_Export_M" />
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <input id="print_orderyby" type="hidden" name="Years" runat="server">
        <%--<asp:Button ID="Button6" Style="display: none" runat="server" Text="Button6"></asp:Button>--%>
        <input id="ISprint" type="hidden" name="ISprint" runat="server">
    </form>
</body>
</html>
