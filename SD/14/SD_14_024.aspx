<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_024.aspx.vb" Inherits="WDAIIP.SD_14_024" %>
        ...
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;招訓簡章</asp:Label>
                </td>
            </tr>
        </table>
