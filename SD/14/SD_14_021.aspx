<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_14_021.aspx.vb" Inherits="WDAIIP.SD_14_021" %>
...
<body>
    <form id="form1" method="post" runat="server">
                    ...
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;表單列印&gt;&gt;契約書</asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table class="table_nw">
                        <tr>
                        ...
                        <%--
                        <tr>
						    <td class="bluecol" width="100">班級狀態</td>
						    <td class="whitecol" colspan="3">
							    <asp:RadioButtonList ID="Radio1" runat="server" Width="128px" RepeatLayout="Flow" RepeatDirection="Horizontal" AutoPostBack="True">
                        ...
                        <tr id="Print_Type" runat="server">
                            <td class="bluecol">列印選項</td>
                            <td class="whitecol" colspan="3">
                                <asp:RadioButtonList ID="Print_Option" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" CssClass="font">
                                    <asp:ListItem Value="1" Selected="True">一般列印</asp:ListItem>
                                    <asp:ListItem Value="2">分印兩頁</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td>
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" CssClass="font" AutoGenerateColumns="False" AllowPaging="True" CellPadding="8">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="STDate" HeaderText="開訓日期" HeaderStyle-Width="15%"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="FTDate" HeaderText="結訓日期" HeaderStyle-Width="15%"></asp:BoundColumn>
                                    </Columns>
        ...
        <%--<asp:HiddenField ID="printtype" runat="server" />--%>
