<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_16_003.aspx.vb" Inherits="WDAIIP.SD_16_003" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        function CheckSave1() {
            ...
            if (ddlYears) { strMsg += chkValue('select', '年度', ddlYears); }
            if (ddlDistID) { strMsg += chkValue('select', '轄區', ddlDistID); }
            if (ddlPlan) { strMsg += chkValue('select', '訓練計畫', ddlPlan); }
                ...
                <td align="center">
                    <table class="font" width="100%">
                        <tr>
				            ...
				            首頁&gt;&gt;學員動態管理&gt;&gt;教務管理&gt;&gt;<font color="#990000">補登審核</font>
                                </asp:Label>
                            </td>
                        </tr>
                    </table>
                    <asp:Panel ID="Panelsch1" runat="server" Visible="True">
                        <table class="font" width="740">
                            <tr>
                                <td align="center">
                                    <table class="table_sch" cellspacing="1" cellpadding="1" width="100%">
                                        <tr id="trYD1" runat="server">
                                            <td class="bluecol_need" style="width: 100px;">年度： </td>
                                            <td class="whitecol" width="330">
                                                <asp:DropDownList ID="sddlYears" runat="server" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td>
                                            <td class="bluecol_need" style="width: 100px;">轄區： </td>
                                            <td class="whitecol">
                                                <asp:DropDownList ID="sddlDistID" runat="server" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr id="trPlan1" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td class="whitecol">
                                                <asp:TextBox ID="sClassName" runat="server" Columns="40" MaxLength="40"></asp:TextBox>
                                            </td>
                                            <td class="bluecol">期別： </td>
                                            <td class="whitecol">
                                                <asp:TextBox ID="sCyclType" runat="server" Columns="5" MaxLength="3"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="bluecol">申請日期區間 </td>
                                            <td class="whitecol" colspan="3">
                                                <asp:TextBox ID="sAPPLYDATE1" runat="server" MaxLength="10" Columns="10"></asp:TextBox>
											...
											<asp:TextBox ID="sAPPLYDATE2" runat="server" MaxLength="10" Columns="10"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td class="whitecol" colspan="3">
                                                <asp:TextBox ID="sENDDATE1" runat="server" MaxLength="10" Columns="10"></asp:TextBox>
											...
											<asp:TextBox ID="sENDDATE2" runat="server" MaxLength="10" Columns="10"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td align="center" class="whitecol" colspan="4">
                                                ...
                                                <asp:Button ID="btnSch" runat="server" Text="查詢" CssClass="asp_button_S"></asp:Button>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td align="center">
                                    <table class="font" id="tbSearch1" style="width: 900px" cellspacing="1" cellpadding="1" width="900" align="center" border="0" runat="server">
                                        <tr>
                                            <td align="center">
                                                <asp:DataGrid ID="DG_ClassInfo" runat="server" Width="900px" CssClass="font" AllowPaging="true" AutoGenerateColumns="False" PageSize="15">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="ACCTNAME" HeaderText="已授權者"></asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="REASON" HeaderText="補登原因及檢討改善作法"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="ENDDATE" HeaderText="結束日期"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="BlameUnitN" HeaderText="是否歸責單位"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="APPLIEDRESULT3" HeaderText="審核結果"></asp:BoundColumn>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="功能">
                                                            <ItemStyle HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lbupdate1" runat="server" Text="審核" CommandName="UPD1" CssClass="linkbutton"></asp:LinkButton>
                    ...
                    <asp:Panel ID="Paneledit1" runat="server" Visible="False">
                        <table class="table_sch" cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                <td class="bluecol" style="width: 100px;">申請日期： </td>
                                <td class="whitecol">
                                    <asp:Label ID="labAPPLYDATE" runat="server"></asp:Label>
                                </td>
                                <td class="bluecol" style="width: 100px;">審核結果： </td>
                                <td class="whitecol">
                                    <asp:Label ID="labAPPLIEDRESULT2" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr id="trYD2" runat="server">
                                <td class="bluecol_need" style="width: 100px;">年度： </td>
                                <td class="whitecol">
                            ...
                            <tr>
                                <td class="bluecol_need">補登原因<br />
                                    及檢討改善作法 </td>
                                <td class="whitecol" colspan="3">
                                    <asp:TextBox ID="txtReason" runat="server" Columns="5" Width="600px" Height="40px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="whitecol">
                                    <asp:TextBox ID="EndDate" Width="80" onfocus="this.blur()" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                <td align="center" class="whitecol" colspan="4">
                                    <asp:Button ID="btnSaveY1" runat="server" Text="審核通過" CssClass="asp_button_M"></asp:Button>
                                    &nbsp;&nbsp;<asp:Button ID="btnSaveN1" runat="server" Text="審核失敗" CssClass="asp_button_M"></asp:Button>
                                    &nbsp;&nbsp;<asp:Button ID="btnQuit1" runat="server" Text="離開" CssClass="asp_button_S"></asp:Button>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
