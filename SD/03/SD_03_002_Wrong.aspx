<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_03_002_Wrong.aspx.vb" Inherits="WDAIIP.SD_03_002_Wrong" %>
                ...
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="font" AllowPaging="True" CellPadding="8">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="Name" HeaderText="姓名" HeaderStyle-Width="20%"></asp:BoundColumn>
                            <asp:BoundColumn DataField="StudentID" HeaderText="學號" HeaderStyle-Width="20%"></asp:BoundColumn>
