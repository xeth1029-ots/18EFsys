<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_02_012.aspx.vb" Inherits="WDAIIP.SD_02_012" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>非自願離職者提醒處理</title>
...
<body>
    <form id="form1" method="post" runat="server">
                    ...
                    <table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
								...
								首頁&gt;&gt;學員動態管理&gt;&gt;招生作業&gt;&gt;<font color="#990000">非自願離職者提醒處理</font>
                                </asp:Label>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td>
                                <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" CssClass="font">
                                    ...
                                    <Columns>
                                        ...
                                        <%--
									<asp:BoundColumn DataField="CFIRE1Reason" HeaderText="處理說明">
										<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="CFIRE1MACCT" HeaderText="修改者">
										<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									</asp:BoundColumn>
                                        --%>
                                        <asp:TemplateColumn HeaderText="處理說明">
                                            ...
                                            <ItemTemplate>
                                                <%--<asp:TextBox ID="CFIRE1Reason" runat="server" Width="100px" MaxLength="150" TextMode="MultiLine"></asp:TextBox><br />--%>
                                                <asp:RadioButtonList ID="CFIRE1R2" runat="server" RepeatLayout="Flow">
                                                    <asp:ListItem Value="1">持推介單</asp:ListItem>
                                                    <asp:ListItem Value="2">簽立權益說明暨同意書</asp:ListItem>
                                                </asp:RadioButtonList>
                                        ...
                                        <%--<asp:TemplateColumn HeaderText="取消提醒">
										<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
										<ItemStyle HorizontalAlign="Center"></ItemStyle>
										<HeaderTemplate>
											取消提醒
        ...
        <%--<asp:RadioButtonList ID="CFIRE1R2X" runat="server" RepeatLayout="Flow">
		<asp:ListItem Value="1" Selected="True">持推介單</asp:ListItem>
		<asp:ListItem Value="2">簽立權益說明暨同意書</asp:ListItem>
	</asp:RadioButtonList>--%>
    </form>
</body>
