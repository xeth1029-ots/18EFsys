<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_02_001_Wrong.aspx.vb" Inherits="WDAIIP.SD_02_001_Wrong" %>


<!DOCTYPE HTML PUBLIC "-//W3C//DTD html 4.0 Transitional//EN">
<html>
<head>
    <title>甄試成績登錄 錯誤資料</title>
                ...
                <td>
                    <asp:DataGrid ID="datagrid1" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="font" AllowPaging="true" CellPadding="8">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="idno" HeaderText="編號"></asp:BoundColumn>
