<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_13_001_16.aspx.vb" Inherits="WDAIIP.SD_13_001_16" %>
                    ...
                    <table class="table_nw" id="Table2" cellspacing="1" cellpadding="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="whitecol">
                                ...
                                <span id="HistoryList" style="display: none; left: 270px; position: absolute"><asp:Table ID="HistoryTable" runat="server" Width="100%"></asp:Table></span>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" class="whitecol"><asp:Button ID="Button1" runat="server" Text="查詢" CssClass="asp_button_M"></asp:Button></td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2" class="whitecol"><asp:Label ID="msg" runat="server" ForeColor="Red"></asp:Label></td>
                        </tr>
                    </table>
                    <table class="font" id="DataGridTable" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                        <tr>
                            <td>滑鼠移至姓名可以顯示此學員前三年的申請紀錄<br><font color="#ff0000" size="2">*表示 該學員未填寫調查表</font> </td>
                        </tr>
                        <tr>
                            <td>
