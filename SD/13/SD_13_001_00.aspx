<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_13_001_00.aspx.vb" Inherits="WDAIIP.SD_13_001_00" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_13_001_00</title>
                ...
                <tr>
                    <td>
                        ...
                        <table class="table_nw" id="Table2" cellspacing="1" cellpadding="1" width="584">
                            ...
                            <tr>
                                <td align="center" colspan="2" class="whitecol"><asp:Button ID="Button1" runat="server" Text="查詢" CssClass="asp_button_S"></asp:Button></td>
                            </tr>
                            <tr>
                        ...
                        <table class="font" id="DataGridTable" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                            <tr>
                                <td>滑鼠移至姓名可以顯示此學員前三年的申請紀錄<br><font color="#ff0000" size="2">*表示為該學員未填寫調查表</font></td>
                            </tr>
                            <tr>
                                <td>
                                        ...
                                        <Columns>
                                            <asp:TemplateColumn SortExpression="StudentID" HeaderText="學號">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TextBox ID="stud1" runat="server" Width="25px" onfocus="this.blur()" Columns="8" MaxLength="3" Enabled="False"></asp:TextBox>
                                                    ...
                                                    <input id="socid" style="width: 22px; height: 22px" type="hidden" runat="server">
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
