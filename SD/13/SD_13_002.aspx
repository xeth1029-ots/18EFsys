<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_13_002.aspx.vb" Inherits="WDAIIP.SD_13_002" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <table class="font" id="FrameTable3" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <table id="DataGridTable" cellspacing="1" cellpadding="1" width="110%" border="0" runat="server">
                        <tr>
                            <td>
                                <div style="width: 100%; overflow-x: auto">
                                    <asp:DataGrid ID="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="font" AllowSorting="True" CellPadding="8">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="Name" HeaderText="姓名" ItemStyle-Wrap="false"></asp:BoundColumn>
                                            ...
                                            <asp:TemplateColumn HeaderText="撥款日期">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtAllotDate" Width="70%" runat="server" MaxLength="12"></asp:TextBox>
                                                    <span runat="server">
                                                        <asp:ImageButton ID="ibtDate" ImageUrl="../../images/show-calendar.gif" runat="server" Height="22px" Width="22px" ImageAlign="Top"></asp:ImageButton>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
        ...
        <asp:HiddenField ID="Hid_AuditList" runat="server" />
    </form>
</body>
</html>
