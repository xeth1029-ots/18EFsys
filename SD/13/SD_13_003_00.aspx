<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_13_003_00.aspx.vb" Inherits="WDAIIP.SD_13_003_00" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>SD_13_003_00</title>
            ...
            <td>
                ...
                <table class="font" id="DataGridTable" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                        ...
                        <td>
                            <asp:DataGrid ID="Datagrid2" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="font" AllowSorting="True">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="出席達2/3">
                                    ...
                                    <asp:TemplateColumn HeaderText="審核">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="btn_BackVerify" runat="server" Text="還原" CommandName="back"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                    ...
                    <tr>
                        <td align="center">
                            <%--
									<asp:button id="Button3" runat="server" Text="儲存"></asp:button>&nbsp;
                            --%>
