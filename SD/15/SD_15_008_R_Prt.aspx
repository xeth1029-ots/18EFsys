<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_15_008_R_Prt.aspx.vb" Inherits="WDAIIP.SD_15_008_R_Prt" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="<%=Request.ApplicationPath%>Scripts/bootstrap.js"></script>
    <script type="text/javascript" src="<%=Request.ApplicationPath%>Scripts/bootstrap-treeview.js"></script>
...
<%--<body>--%>
<body background="../../images/rptpic/temple/TIMS_2.jpg">
