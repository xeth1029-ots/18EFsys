<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_15_024_R.aspx.vb" Inherits="WDAIIP.SD_15_024_R" %>
...
<body background="../../images/rptpic/temple/TIMS_1.jpg" onload="PageLoad();">
    ...
    <form id="form1" method="post" runat="server">
        <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td align="center">(<asp:Label ID="Label1" runat="server"></asp:Label>)年度&nbsp;
                    <%--<asp:Label id="lb_Plan" runat="server"></asp:Label>--%>
                    交叉分析統計表
                </td>
            </tr>
            <tr>
                <td align="right">資料日期：<asp:Label ID="PrintDate" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
