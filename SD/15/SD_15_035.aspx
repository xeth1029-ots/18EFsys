<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SD_15_035.aspx.vb" Inherits="WDAIIP.SD_15_035" %>

<!DOCTYPE html PUBLIC "-//W3C//Dtd html 4.0 transitional//EN">
<html>
<head>
    <title>參訓STEM及ICT人數</title>
        ...
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;學員動態管理&gt;&gt;統計表&gt;&gt;參訓STEM及ICT人數</asp:Label>
                </td>
            </tr>
        </table>
                ...
                <td>
                    <table class="table_nw" id="table3" cellspacing="1" cellpadding="1" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td class="bluecol">管考類別</td>
                            <td class="whitecol" colspan="3">
                                <asp:RadioButtonList ID="RBL_MECTYPE" runat="server" CssClass="font" RepeatLayout="Flow" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="STEM" Selected="True">STEM</asp:ListItem>
