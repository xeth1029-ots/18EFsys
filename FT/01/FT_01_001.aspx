<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FT_01_001.aspx.vb" Inherits="WDAIIP.FT_01_001" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;定版數據統計表&gt;&gt;當年度實務給付</asp:Label>
                </td>
            </tr>
        </table>
