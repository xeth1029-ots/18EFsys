<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FT_01_005.aspx.vb" Inherits="WDAIIP.FT_01_005" %>
...
<body>
    <form id="form1" runat="server">
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;定版數據統計表&gt;&gt;薪資分析明細表</asp:Label>
                </td>
            </tr>
        </table>
        <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
            ...
            <tr>
                <td class="bluecol_need" width="20%">學員參訓年度</td>
                <td colspan="3" class="whitecol" width="80%">
            ...
            <%-- <tr>
                ...
                <td colspan="3" class="whitecol">
                    <asp:RadioButtonList ID="rbl_BDATAVER" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal"></asp:RadioButtonList>版
                </td>
            </tr>--%>
            <%--<tr>
