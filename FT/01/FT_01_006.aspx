<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FT_01_006.aspx.vb" Inherits="WDAIIP.FT_01_006" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;定版數據統計表&gt;&gt;薪資分析統計表</asp:Label>
                </td>
            </tr>
        </table>
