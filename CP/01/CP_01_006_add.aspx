<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CP_01_006_add.aspx.vb" Inherits="WDAIIP.CP_01_006_add" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OpenLessonTeah1(opentype) {
            wopen('../../CP/01/ListTeah.aspx?RID=' + document.form1.RIDValue.value
					+ '&Channel=CP_01_006_add&type=' + opentype
					+ '&fieldname=1'
        ...
        <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%" class="table_sch">
            <tr>
                <td>
					...
					<tr>
						<td>首頁&gt;&gt;學員動態管理&gt;&gt;教務管理&gt;&gt;<font color="#990000">不預告實地抽訪紀錄表</font> </td>
					</tr>
				</table>--%>
                    <table id="Table3" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="whitecol">
                                ...
                                <input id="Button3" onclick="javascript: window.open('../CP_01_ch.aspx?RID=' + document.form1.RIDValue.value, '', 'width=540,height=520,location=0,status=0,menubar=0,scrollbars=1,resizable=0');" value="..." type="button" name="Button3" runat="server" class="button_b_Mini">
                        ...
                        <tr>
                            ...
                            <td class="whitecol">
                                <asp:TextBox ID="ApplyDate" runat="server" onfocus="this.blur()" Width="18%" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('ApplyDate','','','CY/MM/DD');" alt="" align="top" src="../../images/show-calendar.gif" width="30" height="30">
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Table4a" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td class="bluecol" width="20%">當日教師</td>
                                        ...
                                        <td class="bluecol" width="20%">當日助教 </td>
                                        <td class="whitecol" width="30%">
                                ...
                                <table id="Table4" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td colspan="4" class="auto-style1">
                                            <p align="center">學員出缺勤狀況</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="whitecol" style="width: 25%">應到人數:<asp:TextBox ID="AuthCount" runat="server" Width="30%"></asp:TextBox>人 </td>
                                        <td class="whitecol" style="width: 25%">實到人數:<asp:TextBox ID="TurthCount" runat="server" Width="30%"></asp:TextBox>人 </td>
                                        <td class="whitecol" style="width: 25%">未到人數:<asp:TextBox ID="TruancyCount" runat="server" Width="30%"></asp:TextBox>人 </td>
                                        <td class="whitecol" style="width: 25%">出席率:<asp:TextBox ID="AtteRate" runat="server" Width="30%" MaxLength="6"></asp:TextBox>%</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="whitecol" colspan="2">其他人數:<asp:TextBox ID="OtherCount" runat="server" Width="16%"></asp:TextBox>人 </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Table6" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td width="100%" colspan="3" class="bluecol">
                                            <p align="center"><font>【一、資料文件查核】</font>&nbsp;</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="33%" class="whitecol">1.學員出缺席管理（簽到表） </td>
                                        <td width="33%" class="whitecol">
                                            <asp:RadioButtonList ID="Data2" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">齊</asp:ListItem>
                                                <asp:ListItem Value="2">缺</asp:ListItem>
                                                <asp:ListItem Value="5">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                        <td rowspan="3" width="33%" class="whitecol"></td>
                                    </tr>
                                    <tr>
                                        <td class="whitecol">2.教學日誌 </td>
                                        <td class="whitecol">
                                    ...
                                    <tr>
                                        <td class="whitecol">其他
										<asp:TextBox ID="Data4_Note" runat="server" Width="60%" MaxLength="100"></asp:TextBox>
                                        </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Data4" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">齊</asp:ListItem>
                                                <asp:ListItem Value="2">缺</asp:ListItem>
                                                <asp:ListItem Value="5">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Table6b" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td colspan="3" class="bluecol" width="100%">
                                            <p align="center"><font>【二、課程執行情形】</font>&nbsp;</p>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="Table6c" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td width="66%" colspan="2" class="bluecol">
                                            <p align="center"><font>三、現場訪查實況：</font></p>
                                        </td>
                                        <td class="bluecol">
                                            <p align="center"><font>其他說明</font></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="33%" class="whitecol">
                                            <asp:RadioButtonList ID="SItem1" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                        ...
                                        <td width="33%" class="whitecol">
                                            <asp:TextBox ID="SItem1_Note" runat="server" Width="100%" MaxLength="100" Height="37px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="whitecol">2.實際上課學員人數簽到表 </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="SItem2" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">相符</asp:ListItem>
                                                <asp:ListItem Value="2">不相符</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                        ...
                                        <td class="whitecol">
                                            <asp:TextBox ID="SItem2_Note" runat="server" Width="100%" MaxLength="100" Height="37px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <%--<tr>
                                        <td class="whitecol">
                            ...
                            <td colspan="2">
                                <table id="Table6d" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    ...
                                    <tr id="LItem_TR" runat="server">
										...
										<asp:TextBox ID="LItem2_1_Date" runat="server" onfocus="this.blur()" Width="15%"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('LItem2_1_Date','','','CY/MM/DD');" alt="" align="top" src="../../images/show-calendar.gif" width="30" height="30">
                                            前補正相關資料，並傳真至轄區 分署 核備。 </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3" class="whitecol">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.其他補充說明<asp:TextBox ID="LItem2_3_Note" runat="server" Width="84%" MaxLength="300" Height="40px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="table7" class="font" border="0" cellspacing="1" width="100%">
                                    <tr>
                                        <td width="20%" class="bluecol">訪視人員單位 </td>
                                        <td colspan="3" class="whitecol">
                                            <asp:TextBox ID="OrgName" runat="server" onfocus="this.blur()" Width="50%" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" class="bluecol">培訓單位人員姓名 </td>
                                        <td class="whitecol" width="30%">
                                            <asp:TextBox ID="CurseName" runat="server" MaxLength="50" Width="50%"></asp:TextBox>
                                        </td>
                                        <td width="20%" class="bluecol">訪視人員姓名 </td>
                                        <td class="whitecol" width="30%">
                                            <asp:TextBox ID="VisitorName" runat="server" MaxLength="50" Width="50%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <div align="center" class="whitecol">
                        ...
                        <input id="Button4" value="回查詢頁面" type="button" name="Button4" runat="server" class="asp_button_M">
