Public Class CP_01_001_add_03
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            '修改動作。
            If Request("OCID") <> "" AndAlso Request("SeqNo") <> "" Then
...
#End Region
    ...
    Sub create(ByVal OCID As String, ByVal SeqNo As String)
        ...
        D4NOTE.Text = Convert.ToString(dr("D4NOTE"))
        ...
        'LEAVECOUNT. 離訓
        LEAVECOUNT.Text = Convert.ToString(dr("LEAVECOUNT"))
        REJECTCOUNT.Text = Convert.ToString(dr("REJECTCOUNT"))
        'ADVJOBCOUNT.Text = Convert.ToString(dr("ADVJOBCOUNT"))
        ...
        'ITEM32.Text = Convert.ToString(dr("ITEM32"))
    ...
    Function CheckData1(ByRef Errmsg As String) As Boolean
        ...
        End If
        If ITEM32.SelectedValue = "" Then Errmsg += "請選擇 缺失處理?" & vbCrLf
    ...
    Protected Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If TIMS.ClearSQM(Request("DOCID")) <> "" Then
            url1 = "CP_01_001.aspx?ID=" & Request("ID") & "&DOCID=" & Request("DOCID")
        End If
    ...
    Sub INSERT_DATA()
        ...
        sql &= "   ,LEAVECOUNT,REJECTCOUNT " & vbCrLf
        ...
        With iCMD
            ...
            .Parameters.Add("DATA4", SqlDbType.VarChar).Value = If(DATA4.SelectedValue = "", Convert.DBNull, DATA4.SelectedValue)
            .Parameters.Add("DATA5", SqlDbType.VarChar).Value = If(DATA5.SelectedValue = "", Convert.DBNull, DATA5.SelectedValue)
            .Parameters.Add("DATA6", SqlDbType.VarChar).Value = If(DATA6.SelectedValue = "", Convert.DBNull, DATA6.SelectedValue)
            ...
            .Parameters.Add("D4C", SqlDbType.Int).Value = Val(D4C.SelectedValue)
            .Parameters.Add("D5C", SqlDbType.Int).Value = Val(D5C.SelectedValue)
            .Parameters.Add("D6C", SqlDbType.Int).Value = Val(D6C.SelectedValue)
            .Parameters.Add("DATA62", SqlDbType.VarChar).Value = If(DATA62.SelectedValue = "", Convert.DBNull, DATA62.SelectedValue)
            .Parameters.Add("DATACOPY62", SqlDbType.VarChar).Value = If(DATACOPY62.Text = "", Convert.DBNull, DATACOPY62.Text)
            .Parameters.Add("D62C", SqlDbType.Int).Value = Val(D62C.SelectedValue)
            ...
            .Parameters.Add("D4NOTE", SqlDbType.VarChar).Value = D4NOTE.Text
            ...
            .Parameters.Add("ITEM3_3", SqlDbType.VarChar).Value = If(ITEM3_3.SelectedValue = "", Convert.DBNull, ITEM3_3.SelectedValue)
            .Parameters.Add("ITEM3_4", SqlDbType.VarChar).Value = If(ITEM3_4.SelectedValue = "", Convert.DBNull, ITEM3_4.SelectedValue)
            .Parameters.Add("ITEM3_5", SqlDbType.VarChar).Value = If(ITEM3_5.SelectedValue = "", Convert.DBNull, ITEM3_5.SelectedValue)
            .Parameters.Add("ITEM4_1", SqlDbType.VarChar).Value = If(ITEM4_1.SelectedValue = "", Convert.DBNull, ITEM4_1.SelectedValue)
            .Parameters.Add("ITEM4_2", SqlDbType.VarChar).Value = If(ITEM4_2.SelectedValue = "", Convert.DBNull, ITEM4_2.SelectedValue)
            .Parameters.Add("ITEM4_3", SqlDbType.VarChar).Value = If(ITEM4_3.SelectedValue = "", Convert.DBNull, ITEM4_3.SelectedValue)
            .Parameters.Add("ITEM4NOTE", SqlDbType.VarChar).Value = ITEM4NOTE.Text
            ...
            .Parameters.Add("ITEM4PROS", SqlDbType.VarChar).Value = ITEM4PROS.Text
    ...
    Sub UPDATE_DATA(ByVal iSEQNO As Integer)
        ...
        sql &= "     ,DATA4 = @DATA4 " & vbCrLf
        sql &= "     ,DATA5 = @DATA5 " & vbCrLf
        sql &= "     ,DATA6 = @DATA6 " & vbCrLf
        sql &= "     ,DATACOPY1 = @DATACOPY1 " & vbCrLf
        sql &= "     ,DATACOPY2 = @DATACOPY2 " & vbCrLf
        sql &= "     ,DATACOPY3 = @DATACOPY3 " & vbCrLf
        sql &= "     ,DATACOPY4 = @DATACOPY4 " & vbCrLf
        sql &= "     ,DATACOPY5 = @DATACOPY5 " & vbCrLf
        sql &= "     ,DATACOPY6 = @DATACOPY6 " & vbCrLf
        'sql &= "    ,D1C = @D1C " & vbCrLf
        'sql &= "    ,D2C = @D2C " & vbCrLf
        sql &= "     ,D3C = @D3C " & vbCrLf
        sql &= "     ,D4C = @D4C " & vbCrLf
        sql &= "     ,D5C = @D5C " & vbCrLf
        sql &= "     ,D6C = @D6C " & vbCrLf
        sql &= "     ,DATA62 = @DATA62 " & vbCrLf
        sql &= "     ,DATACOPY62 = @DATACOPY62 " & vbCrLf
        sql &= "     ,D62C = @D62C " & vbCrLf
        ...
        'sql &= "    ,D1NOTE = @D1NOTE " & vbCrLf
        'sql &= "    ,D2NOTE = @D2NOTE " & vbCrLf
        sql &= "     ,D3NOTE = @D3NOTE " & vbCrLf
        sql &= "     ,D4NOTE = @D4NOTE " & vbCrLf
        'sql &= "    ,D5NOTE = @D5NOTE " & vbCrLf
        'sql &= "    ,D6NOTE = @D6NOTE " & vbCrLf
        ...
        sql &= "     ,ITEM3_3 = @ITEM3_3 " & vbCrLf
        sql &= "     ,ITEM3_4 = @ITEM3_4 " & vbCrLf
        sql &= "     ,ITEM3_5 = @ITEM3_5 " & vbCrLf
        sql &= "     ,ITEM4_1 = @ITEM4_1 " & vbCrLf
        sql &= "     ,ITEM4_2 = @ITEM4_2 " & vbCrLf
        sql &= "     ,ITEM4_3 = @ITEM4_3 " & vbCrLf
        sql &= "     ,ITEM4NOTE = @ITEM4NOTE " & vbCrLf
        ...
        sql &= "     ,ITEM4PROS = @ITEM4PROS " & vbCrLf
        ...
        With uCMD
            ...
            .Parameters.Add("ITEM4_2", SqlDbType.VarChar).Value = If(ITEM4_2.SelectedValue = "", Convert.DBNull, ITEM4_2.SelectedValue)
            .Parameters.Add("ITEM4_3", SqlDbType.VarChar).Value = If(ITEM4_3.SelectedValue = "", Convert.DBNull, ITEM4_3.SelectedValue)
            '.Parameters.Add("ITEM4NOTE", SqlDbType.NText).Value = ITEM4NOTE.Text
            '.Parameters.Add("ITEM7NOTE", SqlDbType.NText).Value = ITEM7NOTE.Text
            '.Parameters.Add("ITEM31NOTE", SqlDbType.NText).Value = ITEM31NOTE.Text
            '.Parameters.Add("ITEM32", SqlDbType.VarChar).Value = If(ITEM32.SelectedValue = "", Convert.DBNull, ITEM32.SelectedValue)
            '.Parameters.Add("ITEM32NOTE", SqlDbType.NText).Value = ITEM32NOTE.Text
            '.Parameters.Add("ITEM1PROS", SqlDbType.NText).Value = ITEM1PROS.Text
            '.Parameters.Add("ITEM2PROS", SqlDbType.NText).Value = ITEM2PROS.Text
            '.Parameters.Add("ITEM3PROS", SqlDbType.NText).Value = ITEM3PROS.Text
            '.Parameters.Add("ITEM4PROS", SqlDbType.NText).Value = ITEM4PROS.Text
            '.Parameters.Add("ITEM1NOTE", SqlDbType.NText).Value = ITEM1NOTE.Text
            '.Parameters.Add("ITEM2NOTE", SqlDbType.NText).Value = ITEM2NOTE.Text
            '.Parameters.Add("ITEM3NOTE", SqlDbType.NText).Value = ITEM3NOTE.Text
            .Parameters.Add("ITEM4NOTE", SqlDbType.VarChar).Value = ITEM4NOTE.Text
            .Parameters.Add("ITEM7NOTE", SqlDbType.VarChar).Value = ITEM7NOTE.Text
            .Parameters.Add("ITEM31NOTE", SqlDbType.VarChar).Value = ITEM31NOTE.Text
            .Parameters.Add("ITEM32", SqlDbType.VarChar).Value = If(ITEM32.SelectedValue = "", Convert.DBNull, ITEM32.SelectedValue)
