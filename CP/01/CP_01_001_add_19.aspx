<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CP_01_001_add_19.aspx.vb" Inherits="WDAIIP.CP_01_001_add_19" %>
            ...
            <tr>
                <td>
                    ...
                    <table class="table_sch" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        ...
                        <tr>
                            <td colspan="4">
                                <table class="table_sch" id="Table4" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr align="center">
                                        <td class="bluecol_center">書面資料</td>
                                        <td class="bluecol_center"></td>
                                        <td class="bluecol_center">佐證資料及說明</td>
                                        <td class="bluecol_center">備註</td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol_center">1.教學(訓練)日誌</td>
                                        <td class="whitecol">
                                    ...
                                    <tr>
                                        <td class="bluecol_center">2.學員簽到(退)表</td>
                                        <td class="whitecol">
                                    ...
                                    <tr>
                                        <td class="bluecol_center">3.請假單</td>
                                        <td class="whitecol">
                                    ...
                                    <tr>
                                        <td class="bluecol_center">4.出缺勤狀況</td>
...
開訓：<asp:TextBox ID="AUTHCOUNT" runat="server" MaxLength="3" Width="10%"></asp:TextBox>人；實到：<asp:TextBox ID="TURTHCOUNT" runat="server" MaxLength="3" Width="10%"></asp:TextBox>人；
請假：<asp:TextBox ID="TURNOUTCOUNT" runat="server" MaxLength="3" Width="10%"></asp:TextBox>人；<br />
                                            缺(曠)課：<asp:TextBox ID="TRUANCYCOUNT" runat="server" MaxLength="3" Width="10%"></asp:TextBox>人；離退訓：<asp:TextBox ID="REJECTCOUNT" runat="server" MaxLength="3" Width="10%"></asp:TextBox>人。<br />
                        ...
                        <tr>
                            <td colspan="4">
                                <table class="table_sch" id="Table5" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    <tr>
                                        <td colspan="2" class="bluecol_center" width="36%">訪查項目 </td>
                                        <td class="bluecol_center" width="20%">訪查實況 </td>
                                        <td class="bluecol_center" width="22%">處理情形 </td>
                                        <td class="bluecol_center" width="22%">備註 </td>
                                    </tr>
                                    <tr>
                                        <td rowspan="4" class="bluecol_center">課程(師資)實施狀況 </td>
                                        ...
                                        <td rowspan="4" class="whitecol">
                                            <asp:TextBox ID="ITEM1PROS" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                        <td rowspan="4" class="whitecol" align="center">
                                            <asp:TextBox ID="ITEM1NOTE" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            ...
                                            教師：<asp:TextBox ID="ITEM1_TEACHER" runat="server" MaxLength="100" Width="60%"></asp:TextBox><br />
                                            助教：<asp:TextBox ID="ITEM1_ASSISTANT" runat="server" MaxLength="100" Width="60%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td rowspan="3" class="bluecol_center">教材設施運用狀況 </td>
                                        ...
                                        <td rowspan="3" class="whitecol">
                                            <asp:TextBox ID="ITEM2PROS" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                        <td rowspan="3" class="whitecol" align="center">
                                            <asp:TextBox ID="ITEM2NOTE" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td rowspan="2" class="bluecol_center">教務管理狀況 </td>
                                        ...
                                        <td rowspan="2" class="whitecol">
                                            <asp:TextBox ID="ITEM3PROS" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                        <td rowspan="2" class="whitecol" align="center">
                                            <asp:TextBox ID="ITEM3NOTE" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="bluecol_center">參訓學員反映意見及問題 </td>
                                        <td colspan="4" class="whitecol">
                                            <asp:TextBox ID="ITEM7NOTE" runat="server" Width="70%" TextMode="MultiLine" Height="80px"></asp:TextBox><br />
                                            (可輸入文字長度為 200 個中文字)</td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol_center">學員反映意見之委訓單位回應說明 </td>
                                        <td colspan="4" class="whitecol">
                                            <asp:TextBox ID="ITEM7NOTE2" runat="server" Width="70%" TextMode="MultiLine" Height="80px"></asp:TextBox><br />
                                            (可輸入文字長度為 300 個中文字)</td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol_center">綜合建議</td>
                                        <td colspan="2" class="whitecol">
                                            <asp:TextBox ID="ITEM31NOTE" runat="server" Width="90%" TextMode="MultiLine" Height="80px"></asp:TextBox>
                                            <br />
                                            (可輸入文字長度為 200 個中文字)</td>
                                        <td class="whitecol" colspan="2" width="40%">
                                            <table class="table_sch" id="Table52" cellspacing="1" cellpadding="1" width="100%" border="0">
                                                <tr>
                                                    <td class="bluecol_center">缺失處理</td>
                                                    <td>
                                                        <asp:CheckBoxList ID="CBL_ITEM32" runat="server">
                                                        ...
                                                        <asp:TextBox ID="ITEM32NOTE" runat="server" Width="80%"></asp:TextBox><br />
                                                        (可輸入文字長度為 100 個中文字)
                                                    </td>
                                                </tr>
                                            </table>
