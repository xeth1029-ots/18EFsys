<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CP_01_006_add9.aspx.vb" Inherits="WDAIIP.CP_01_006_add9" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Calculate2() {
            /* "在學員動態管理>>教務管理>>不預告實地抽訪紀錄表，由系統自動帶出應到人數及計算出席率
            公式：,應到人數=參訓人數-退訓人數,  AuthCount=Hid_StudCount-RejectCount, 出席率=(實到人數+請假人數)/應到人數 "
            AtteRate=(TurthCount+TurnoutCount) /AuthCount */
            //debugger;
        ...
        function chkdata() {
            ...
            if (!isChecked(document.form1.Item1)) msg += '請回答 課程內容是否變動?\n';
            if (!isChecked(document.form1.Item2)) msg += '請回答 是否正常上課?\n';
            if (!isChecked(document.form1.Item3)) msg += '請回答 實地訓練場地是否有異動?\n';
            if (!isChecked(document.form1.Item4)) msg += '請回答 抽訪學員是否與名單相符?\n';
            if (document.form1.Stud_Name.value == '') msg += '請輸入抽訪學員之姓名1\n';
            if (document.form1.Stud_Name2.value == '') msg += '請輸入抽訪學員之姓名2\n';
            if (!isChecked(document.form1.SItem1)) msg += '請回答 抽訪學員之姓名1是否相符?\n';
            if (!isChecked(document.form1.SItem1b)) msg += '請回答 抽訪學員之姓名2是否相符?\n';
            ...
            if (checkMaxLen(document.getElementById('SItem1_Note').value, 100 * 2)) {
                msg += '【1.抽訪學員之姓名1 其他說明】長度不可超過100字元\n';
            }
            if (checkMaxLen(document.getElementById('SItem1b_Note').value, 100 * 2)) {
                msg += '【1.抽訪學員之姓名2 其他說明】長度不可超過100字元\n';
            }
                ...
                <td>
                    ...
                    <table id="Table3" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="whitecol" colspan="3">
                                <asp:TextBox ID="ApplyDate" runat="server" onfocus="this.blur()" Width="22%" MaxLength="10"></asp:TextBox>
                                ...
                                <input style="width: 11%" id="Applytime_HH" maxlength="2" runat="server">點：
							    <input style="width: 11%" id="Applytime_MM" maxlength="2" runat="server">分
                            </td>
                        </tr>
                        <tr>
                            <td class="bluecol" style="width: 20%">當日教師</td>
                            <td class="whitecol" style="width: 30%">
                                <asp:TextBox Style="cursor: pointer" ID="OLessonTeah1" onfocus="this.blur()" Width="66%" MaxLength="110" runat="server" ToolTip="點選兩下可以跳出視窗選擇教師"></asp:TextBox>
                            ...
                            <td class="whitecol" style="width: 30%">
                                <asp:TextBox Style="cursor: pointer" ID="OLessonTeah2" onfocus="this.blur()" Width="66%" MaxLength="110" runat="server" ToolTip="點選兩下可以跳出視窗選擇教師"></asp:TextBox>
                        ...
                        <tr>
                            <td class="bluecol">當日課程 </td>
                            <td colspan="3" class="whitecol">
                                <asp:TextBox ID="CourseName" runat="server" Width="90%" Rows="5" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="bluecol">訪查方式</td>
                            <td colspan="3" class="whitecol">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <table id="Table4" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td class="whitecol">應到人數:<asp:TextBox ID="AuthCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                                        <td class="whitecol">實到人數:<asp:TextBox ID="TurthCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                                        <td class="whitecol">未到人數:<asp:TextBox ID="TruancyCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                                        <td class="whitecol">出席率:<asp:TextBox ID="AtteRate" runat="server" Width="44%" MaxLength="6" onfocus="this.blur()"></asp:TextBox>%</td>
                                    </tr>
                                    <tr>
                                        <td class="whitecol">退訓人數:<asp:TextBox ID="RejectCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                                        <td class="whitecol">請假人數:<asp:TextBox ID="TurnoutCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                                        <td class="whitecol">其他人數:<asp:TextBox ID="OtherCount" runat="server" Width="44%"></asp:TextBox>人 </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <table id="Table61" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <table id="Table62" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="whitecol">3.實地訓練場地是否有異動？ </td>
                                        <td class="whitecol">
                        ...
                        <tr>
                            <td class="bluecol">【三、屬遠距課程方須填寫】</td>
                            <td colspan="3">
                                <table id="Table63" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    <tr>
                                        <td width="33%" class="whitecol">1.是否可順利連線？ </td>
                                        <td width="33%" class="whitecol">
                                            <asp:RadioButtonList ID="SITEMR3_1" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        <td class="whitecol">2.是否有學員未使用本名？ </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="SITEMR3_2" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        <td class="whitecol">3.學員上課螢幕擷圖？ </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="SITEMR3_3" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        <td class="whitecol">4.是否有學員使用虛擬背景？ </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="SITEMR3_4" runat="server" CssClass="font" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                ...
                                <table id="Table6c" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    ...
                                    <tr>
                                        <td width="33%" class="whitecol">1.抽訪學員之姓名1<font color="#ff0066"><strong>*</strong></font>
                                            <asp:TextBox ID="Stud_Name" runat="server" Width="66%" MaxLength="10"></asp:TextBox><br />
                                        </td>
                                        <td width="33%" class="whitecol">
                                            <asp:RadioButtonList ID="SItem1" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                                ...
                                                <asp:ListItem Value="5">抽訪時未到</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    ...
                                    <tr>
                                        <td width="33%" class="whitecol">1.抽訪學員之姓名2<font color="#ff0066"><strong>*</strong></font>
                                            <asp:TextBox ID="Stud_Name2" runat="server" Width="66%" MaxLength="10"></asp:TextBox>
                                        </td>
                                        <td width="33%" class="whitecol">
                                            <asp:RadioButtonList ID="SItem1b" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                                <asp:ListItem Value="1">相符</asp:ListItem>
                                                <asp:ListItem Value="2">不相符</asp:ListItem>
                                                <asp:ListItem Value="5">抽訪時未到</asp:ListItem>
                                                <asp:ListItem Value="3">其他</asp:ListItem>
                                        ...
                                        <td width="33%" class="whitecol">其他說明<asp:TextBox ID="SItem1b_Note" runat="server" MaxLength="100" Height="40px" TextMode="MultiLine" Width="70%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <td colspan="3">
                                <table id="Table6d" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                                    ...
                                    <tr id="LItem_TR2" runat="server">
                                        ...
                                        <td colspan="2" class="whitecol" Width="78%">
                                            <asp:CheckBoxList ID="cblLItem2_2b" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                    ...
                                    <tr>
                                        <td colspan="3" class="whitecol">&nbsp;&nbsp;&nbsp;&nbsp;3.其他補充說明<asp:TextBox ID="LItem2_3_Note" runat="server" Width="84%" Height="40px" TextMode="MultiLine"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                ...
                                <asp:TextBox ID="SITEM51_NOTE" runat="server" MaxLength="300" Width="90%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                ...
                                <asp:TextBox ID="SITEM61_NOTE" runat="server" MaxLength="300" Width="90%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                ...
                                <asp:TextBox ID="SITEM71_NOTE" runat="server" MaxLength="300" Width="90%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                ...
                                <asp:TextBox ID="SITEM81_NOTE" runat="server" MaxLength="300" Width="90%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="whitecol">
                                <asp:TextBox ID="OrgName" runat="server" onfocus="this.blur()" Width="88%" MaxLength="50"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td width="15%" class="bluecol">培訓單位人員姓名 </td>
                            <td class="whitecol">
                                <asp:TextBox ID="CurseName" runat="server" MaxLength="50" Width="90%"></asp:TextBox></td>
                            <td width="15%" class="bluecol">訪視人員姓名 </td>
                            <td class="whitecol">
                                <asp:TextBox ID="VisitorName" runat="server" MaxLength="50" Width="90%"></asp:TextBox></td>
                        </tr>
                    </table>
