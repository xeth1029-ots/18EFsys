Partial Class CP_01_001_add_99
...
#End Region
        ...
        If Not dr Is Nothing Then
            ...
            For i As Integer = 0 To Data1.Items.Count - 1 '教學(訓練)日誌
                Data1.Items(i).Selected = False
            ...
            Else
                D1c.Checked = False
            End If
            For i As Integer = 0 To Data3.Items.Count - 1 '學員簽到(退)表
                Data3.Items(i).Selected = False
            ...
            Else
                D2c.Checked = False
            End If
            For i As Integer = 0 To Data5.Items.Count - 1 '請假單
                Data5.Items(i).Selected = False
            ...
            If dr("D3c").ToString <> "" Then
                ...
                End If
            End If
            D3c3.SelectedIndex = -1
            If dr("D3c3").ToString <> "" Then  '說明的選項
                Common.SetListItem(D3c3, dr("D3c3"))
            Else
                D3c3.SelectedIndex = -1
            End If
            For i As Integer = 0 To Data6.Items.Count - 1 '退訓/提前就業
                Data6.Items(i).Selected = False
            ...
            If dr("D4c").ToString <> "" Then
                ...
                End If
            End If
            If dr("D4c3").ToString <> "" Then  '說明的選項
                'D4c3.SelectedValue = dr("D4c3")
                Common.SetListItem(D4c3, dr("D4c3"))
            Else
                D4c3.SelectedIndex = -1
            End If

#Region "(No Use)"

            'For i = 0 To Data7.Items.Count - 1 '勞保加/退
            '    If Convert.ToString(dr("Data7")) = Data7.Items(i).Value Then
            '        Data7.Items(i).Selected = True
            '    End If
            'Next
            ...
            'If dr("D5c3").ToString <> "" Then  '說明的選項
            '    D5c3.SelectedValue = dr("D5c3")
            'End If

            'For i = 0 To Data9.Items.Count - 1 '學員書籍(講義)
            '    If Convert.ToString(dr("Data9")) = Data9.Items(i).Value Then
            '        Data9.Items(i).Selected = True
            '    End If
            'Next
...
#End Region
            ...
            For i As Integer = 0 To Data10.Items.Count - 1 '職訓生活津貼
                Data10.Items(i).Selected = False
            ...
            If dr("D7c3").ToString <> "" Then  '說明的選項
                Common.SetListItem(D7c3, dr("D7c3"))
            Else
                D7c3.SelectedIndex = -1
            End If

#Region "(No Use)"

            'For i = 0 To Data11.Items.Count - 1 '學員服務手皿
            '    If Convert.ToString(dr("Data11")) = Data11.Items(i).Value Then
            '        Data11.Items(i).Selected = True
            '    End If
            'Next
...
#End Region
            ...
            '課程(師資)實施狀況
            For i As Integer = 0 To Item1_1.Items.Count - 1
                Item1_1.Items(i).Selected = False
                If Convert.ToString(dr("Item1_1")) = Item1_1.Items(i).Value Then Item1_1.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item1_2.Items.Count - 1
                Item1_2.Items(i).Selected = False
            ...
            For i As Integer = 0 To Item3_1.Items.Count - 1
                Item3_1.Items(i).Selected = False
            ...
            '教材設施運用狀況
            For i As Integer = 0 To Item19.Items.Count - 1
                Item19.Items(i).Selected = False
                If Convert.ToString(dr("Item19")) = Item19.Items(i).Value Then Item19.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item20.Items.Count - 1
                Item20.Items(i).Selected = False
                If Convert.ToString(dr("Item20")) = Item20.Items(i).Value Then Item20.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item21.Items.Count - 1
                Item21.Items(i).Selected = False
            ...
            '教務管理狀況
            For i As Integer = 0 To Item2_1.Items.Count - 1
                Item2_1.Items(i).Selected = False
                If Convert.ToString(dr("Item2_1")) = Item2_1.Items(i).Value Then Item2_1.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item2_2.Items.Count - 1
                Item2_2.Items(i).Selected = False
                If Convert.ToString(dr("Item2_2")) = Item2_2.Items(i).Value Then Item2_2.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item23.Items.Count - 1
                Item23.Items(i).Selected = False
                If Convert.ToString(dr("Item23")) = Item23.Items(i).Value Then Item23.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item24.Items.Count - 1
                Item24.Items(i).Selected = False
                If Convert.ToString(dr("Item24")) = Item24.Items(i).Value Then Item24.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item25.Items.Count - 1
                Item25.Items(i).Selected = False
                If Convert.ToString(dr("Item25")) = Item25.Items(i).Value Then Item25.Items(i).Selected = True
            Next
            For i As Integer = 0 To Item26.Items.Count - 1
                Item26.Items(i).Selected = False
...
#Region "(No Use)"
            ...
            '    If Convert.ToString(dr("Item28_2")) = Item28_2.Items(i).Value Then
            '        Item28_2.Items(i).Selected = True
            '    End If
            'Next

#End Region
            For i As Integer = 0 To Item6_1.Items.Count - 1
                Item6_1.Items(i).Selected = False
                If Convert.ToString(dr("Item6_1")) = Item6_1.Items(i).Value Then
                    Item6_1.Items(i).Selected = True
                End If
            Next
            ...
            Item32_1.Checked = False
            Item32_2.Checked = False
            Item32_3.Checked = False
            Item32_4.Checked = False
            If Convert.ToString(dr("Item32")) <> "" Then
                If Convert.ToString(dr("Item32")) = "1" Then Item32_1.Checked = True 'dr("Item32")
                If Convert.ToString(dr("Item32")) = "2" Then Item32_2.Checked = True 'dr("Item32")
                If Convert.ToString(dr("Item32")) = "3" Then Item32_3.Checked = True 'dr("Item32")
                If Convert.ToString(dr("Item32")) = "4" Then Item32_4.Checked = True 'dr("Item32")
            End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Request("OCID") = "" Then '表示新增狀態
            ...
            End If
            '先取出最大SeqNo
            sql = "SELECT MAX(SeqNO) num FROM Class_Visitor WHERE OCID='" & OCIDValue1.Value & "'"
            dr = DbAccess.GetOneRow(sql, objconn)
            If Not dr Is Nothing Then
...
#End Region
            sql = " SELECT * FROM Class_Visitor WHERE 1<>1 "
...
#Region "(No Use)"
            ...
            'CLASS_VISITOR()
            'SELECT TABLE_NAME,COLUMN_NAME,DATA_TYPE,DATA_LENGTH,CHAR_COL_DECL_LENGTH,CHAR_LENGTH CHARACTER_MAXIMUM_LENGTH
            'FROM USER_TAB_COLUMNS
            'WHERE 1=1
            'and  TABLE_NAME IN ('CLASS_VISITOR')--,'STUD_SUBDATA','STUD_SERVICEPLACE','STUD_TRAINBG')
            'AND DATA_TYPE IN ('NCLOB' )

#End Region
            sql = ""
            sql &= " SELECT * FROM Class_Visitor WHERE 1=1 AND OCID = '" & Request("OCID") & "' AND SeqNo = '" & Request("SeqNo") & "' "
            dt = DbAccess.GetDataTable(sql, da, objconn)
            dr = dt.Rows(0)
...
#Region "(No Use)"
        ...
        'If D8c3.SelectedIndex <> -1 Then   '說明的check
        '    dr("D8c3") = D8c3.SelectedValue
        'End If
...
#End Region
        ...
        dr("RejectCount") = 0
        dr("AheadjobCount") = 0
        If AuthCount.Text <> "" Then dr("AuthCount") = Val(AuthCount.Text) '核定人數
        If TurthCount.Text <> "" Then dr("TurthCount") = Val(TurthCount.Text) '實到人數
        If TurnoutCount.Text <> "" Then dr("TurnoutCount") = Val(TurnoutCount.Text) '請假人數
        If TruancyCount.Text <> "" Then dr("TruancyCount") = Val(TruancyCount.Text) '缺(曠)課人數
        If RejectCount.Text <> "" Then dr("RejectCount") = Val(RejectCount.Text) '退訓人數
        If AheadjobCount.Text <> "" Then dr("AheadjobCount") = Val(AheadjobCount.Text) '提前就業人數
        ...
        dr("Item3_1Tutor") = Convert.DBNull
        dr("Item1Pros") = Convert.DBNull
        dr("Item1Note") = Convert.DBNull
        ...
        dr("Item19") = Convert.DBNull
        dr("Item20") = Convert.DBNull
        dr("Item21") = Convert.DBNull
        If Item19.SelectedValue <> "" Then dr("Item19") = Val(Item19.SelectedValue) '有無書籍(講義)領用表
        If Item20.SelectedValue <> "" Then dr("Item20") = Val(Item20.SelectedValue) '有無材料領用表
        If Item21.SelectedValue <> "" Then dr("Item21") = Val(Item21.SelectedValue) '訓練設施設備是否依契約提供學員使用
        dr("Item2Pros") = Convert.DBNull
        dr("Item2Note") = Convert.DBNull
        ...
        dr("Item3Pros") = Convert.DBNull
        dr("Item3Note") = Convert.DBNull
...
#Region "(No Use)"
        ...
        'If Item28Count.Text <> "" Then '有自費參訓學員人數
        '    dr("Item28Count") = Item28Count.Text
        'End If

#End Region
        dr("Item6_1") = Item6_1.SelectedValue '職業訓練生活津貼是否依規定申請並核發
        'dr("Item29") = Item29.SelectedValue '培訓單位無巧立名目強制收取費用
        dr("Item4Pros") = Convert.DBNull
        dr("Item4Note") = Convert.DBNull
...
#Region "(No Use)"
        ...
        'If Item5Pros.Text <> "" Then
        '    dr("Item5Pros") = Item5Pros.Text
        'End If
        'If Item5Note.Text <> "" Then
        '    dr("Item5Note") = Item5Note.Text
        'End If

#End Region
        dr("Item7Note") = Convert.DBNull
        dr("Item31Note") = Convert.DBNull
        If Item7Note.Text <> "" Then dr("Item7Note") = Item7Note.Text '參訓學員反映意見及問題
        If Item31Note.Text <> "" Then dr("Item31Note") = Item31Note.Text '綜合建議
        Select Case True
            Case Item32_1.Checked
                dr("Item32") = Item32_1.Value '缺失處理
            Case Item32_2.Checked
                dr("Item32") = Item32_2.Value '缺失處理
            Case Item32_3.Checked
                dr("Item32") = Item32_3.Value '缺失處理
            Case Item32_4.Checked
                dr("Item32") = Item32_4.Value '缺失處理
            Case Else
                dr("Item32") = Convert.DBNull
        End Select
        dr("Item32Note") = Convert.DBNull
        ...
        Catch ex As Exception
            ...
            Common.MessageBox(Me, "儲存失敗，請重新檢查輸入資料。")
