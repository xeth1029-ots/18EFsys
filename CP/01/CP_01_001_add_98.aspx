<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CP_01_001_add_98.aspx.vb" Inherits="WDAIIP.CP_01_001_add_98" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function chkdata() {
            ...
            if (document.getElementById('D7c').checked) { if (document.form1.DataCopy10.value == '') msg += '請輸入第7題的附件內容?\n'; }
            if (document.getElementById('D8c').checked) { if (document.form1.DataCopy11.value == '') msg += '請輸入第8題的附件內容?\n'; }
            if (document.getElementsByName('D3c3').item(2).checked) { if (document.form1.Data5Note.value == '') msg += '請輸入第3題的其他說明?\n'; }
            if (document.getElementsByName('D4c3').item(2).checked) { if (document.form1.Data6Note.value == '') msg += '請輸入第4題的其他說明?\n'; }
            if (document.getElementsByName('D5c3').item(2).checked) { if (document.form1.Data7Note.value == '') msg += '請輸入第5題的其他說明?\n'; }
            if (document.getElementsByName('D6c3').item(2).checked) { if (document.form1.Data9Note.value == '') msg += '請輸入第6題的其他說明?\n'; }
            if (document.getElementsByName('D7c3').item(3).checked) { if (document.form1.Data10Note.value == '') msg += '請輸入第7題的其他說明?\n'; }
            if (document.getElementsByName('D8c3').item(2).checked) { if (document.form1.Data11Note.value == '') msg += '請輸入第8題的其他說明?\n'; }
            if (msg != '') {
                alert(msg);
                return false;
            }
                    ...
                    <table class="font" id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            ...
                            <td width="80%" class="whitecol">
                                ...
                                <input id="NowDate" type="hidden" name="NowDate" runat="server"><br />
                            ...
                            <td colspan="2">
                                <table class="font" id="Table6" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:TextBox ID="Data1Note" runat="server" Width="90%" TextMode="MultiLine" MaxLength="100"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:TextBox ID="Data3Note" runat="server" Width="90%" TextMode="MultiLine" MaxLength="100"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="bluecol">5.勞保加／退保明細表</td>
                                        <td class="whitecol">
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButton ID="D5c" runat="server"></asp:RadioButton>如附件
												<asp:TextBox ID="DataCopy7" runat="server" Width="50%"></asp:TextBox><br />
                                            <asp:RadioButton ID="D5c2" runat="server"></asp:RadioButton>免提供
                                        </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="D5c3" runat="server">
                                                <asp:ListItem Value="1">攜回影本</asp:ListItem>
                                                <asp:ListItem Value="2">前次訪查已提供過，故免提供</asp:ListItem>
                                                <asp:ListItem Value="3">其他(請說明)：</asp:ListItem>
                                            </asp:RadioButtonList><asp:TextBox ID="Data7Note" runat="server" Width="90%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">6.學員書籍(講義)、材料領用表</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Data9" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">備齊</asp:ListItem>
                                                <asp:ListItem Value="3">部份備有</asp:ListItem>
                                                <asp:ListItem Value="2">未備</asp:ListItem>
                                            </asp:RadioButtonList>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButton ID="D6c" runat="server"></asp:RadioButton>如附件
                                            <asp:TextBox ID="DataCopy9" runat="server" Width="50%"></asp:TextBox><br />
                                            <asp:RadioButton ID="D6c2" runat="server"></asp:RadioButton>免提供
                                        </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="D6c3" runat="server">
                                                <asp:ListItem Value="1">攜回影本</asp:ListItem>
                                                <asp:ListItem Value="2">前次訪查已提供過，故免提供</asp:ListItem>
                                                <asp:ListItem Value="3">其他(請說明)：</asp:ListItem>
                                            </asp:RadioButtonList><asp:TextBox ID="Data9Note" runat="server" Width="90%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">7.職業訓練生活津貼補助印領清冊</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Data10" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">備齊</asp:ListItem>
                                                <asp:ListItem Value="3">部份備有</asp:ListItem>
                                                <asp:ListItem Value="2">未備</asp:ListItem>
                                            </asp:RadioButtonList></td>
                                        <td class="whitecol">
                                            ...
                                            <asp:RadioButton ID="D7c2" runat="server"></asp:RadioButton>免提供</td>
                                        <td class="whitecol">
                                            ...
                                            </asp:RadioButtonList><asp:TextBox ID="Data10Note" runat="server" Width="90%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">8.學員服務手冊或權利義務公告<br />
                                            相關文件</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Data11" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">備齊</asp:ListItem>
                                                <asp:ListItem Value="3">部份備有</asp:ListItem>
                                                <asp:ListItem Value="2">未備</asp:ListItem>
                                            </asp:RadioButtonList>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButton ID="D8c" runat="server"></asp:RadioButton>如附件
												<asp:TextBox ID="DataCopy11" runat="server" Width="50%"></asp:TextBox><br />
                                            <asp:RadioButton ID="D8c2" runat="server"></asp:RadioButton>免提供
                                        </td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="D8c3" runat="server">
                                                <asp:ListItem Value="1">攜回影本</asp:ListItem>
                                                <asp:ListItem Value="2">前次訪查已提供過，故免提供</asp:ListItem>
                                                <asp:ListItem Value="3">其他(請說明)：</asp:ListItem>
                                            </asp:RadioButtonList>
                                            <asp:TextBox ID="Data11Note" runat="server" Width="90%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bluecol">9.出缺勤狀況</td>
                                        <td id="notstudy3" colspan="3" runat="server" class="whitecol">核定：<asp:TextBox ID="AuthCount" runat="server" Width="10%"></asp:TextBox>人； 
                                            實到：<asp:TextBox ID="TurthCount" runat="server" Width="10%"></asp:TextBox>人； 
                                            請假：<asp:TextBox ID="TurnoutCount" runat="server" Width="10%"></asp:TextBox>人； 
                                            缺(曠)課：<asp:TextBox ID="TruancyCount" runat="server" Width="10%"></asp:TextBox>人；<br />
                                            退訓：<asp:TextBox ID="RejectCount" runat="server" Width="10%"></asp:TextBox>人； 
                                            (含提前就業：<asp:TextBox ID="AheadjobCount" runat="server" Width="10%"></asp:TextBox>人)。 ※點名未到課學員，另以電話抽訪。
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td colspan="2">
                                <table class="font" id="Table5" cellspacing="1" cellpadding="1" width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item19" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">有</asp:ListItem>
                                                <asp:ListItem Value="2">無</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item20" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">有</asp:ListItem>
                                                <asp:ListItem Value="2">無</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item21" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item23" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item24" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item25" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item26" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        <td rowspan="4" class="bluecol">費用(津貼)收核狀況</td>
                                        <td class="whitecol">1.有無自費參訓學員?幾人?</td>
                                        <td class="whitecol">
                                            <input id="Item28_11" type="radio" value="1" name="Item28" runat="server">有，
                                            <asp:TextBox ID="Item28Count" runat="server" Width="20%"></asp:TextBox>人
                                            <input id="Item28_12" type="radio" value="2" name="Item28" runat="server">無
                                        </td>
                                        <td rowspan="4" class="whitecol">
                                    ...
                                    <tr>
                                        <td class="whitecol">訓練費用是否繳交主辦單位?</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item28_2" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="2">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="whitecol">2.職業訓練生活津貼是否依規定申請並核發?</td>
                                        <td class="whitecol">
                                    ...
                                    <tr>
                                        <td class="whitecol">3.培訓單位是否巧立名目強制收取費用?</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item29" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                    ...
                                    <tr>
                                        <td class="bluecol">職業訓練機構<br />
                                            設立許可狀況</td>
                                        <td class="whitecol">職業訓練構是否依規定懸掛設立許可證書?(委外訓練之承訓單位為職業訓練機構)</td>
                                        <td class="whitecol">
                                            <asp:RadioButtonList ID="Item30" runat="server" RepeatDirection="Horizontal" CssClass="font">
                                                <asp:ListItem Value="1">是</asp:ListItem>
                                                <asp:ListItem Value="2">否</asp:ListItem>
                                                <asp:ListItem Value="3">免填</asp:ListItem>
                                            </asp:RadioButtonList>
                                        ...
                                        <td class="whitecol">
                                            <asp:TextBox ID="Item5Pros" runat="server" Width="90%" TextMode="MultiLine" Height="60px"></asp:TextBox></td>
                                        <td class="whitecol">
                                            <asp:TextBox ID="Item5Note" runat="server" Width="90%" TextMode="MultiLine" Height="60px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitecol">
                                            ...
                                            <input id="Item32_3" type="radio" value="3" name="Item32" runat="server">其他(請說明)：<br />
                                            <asp:TextBox ID="Item32Note" runat="server" Width="60%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table class="font" id="table7" cellspacing="1" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td class="whitecol" width="22%">
                                            <asp:TextBox ID="VisitorName" runat="server" MaxLength="10" Width="70%"></asp:TextBox></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
