<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CP_07_001_Wrong.aspx.vb" Inherits="WDAIIP.CP_07_001_Wrong" %>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="font" AllowPaging="true">
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="Index" HeaderText="序號"></asp:BoundColumn>
                            <asp:BoundColumn DataField="STUDID2" HeaderText="學號"></asp:BoundColumn>
