<%@ Page AspCompat="true" Language="vb" AutoEventWireup="false" CodeBehind="CP_02_002_R.aspx.vb" Inherits="WDAIIP.CP_02_002_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>CP_02_002_R</title>
...
<body>
    <form id="form1" method="post" runat="server">
        <table id="Table1" border="0" cellspacing="1" cellpadding="1" width="740">
            <tr>
                <td>
                    <table id="Table2" class="font" border="0" cellspacing="1" cellpadding="1" width="100%">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;訓練查核與績效管理&gt;&gt;公務統計報表&gt;&gt;<font color="#990000">訓練機構機暨訓練性質別-結訓學員人數統計表</font></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table id="Table3" class="table_sch" cellspacing="1" cellpadding="1">
					    ...
					    <TR>
							...
							<TD bgColor="#ffecec"><asp:checkboxlist id="TPlan" runat="server" RepeatColumns="3" CssClass="font"></asp:checkboxlist></TD>
						</TR>
                        --%>
