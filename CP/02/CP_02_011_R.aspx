<%@ Page AspCompat="true" Language="vb" AutoEventWireup="false" CodeBehind="CP_02_011_R.aspx.vb" Inherits="WDAIIP.CP_02_011_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
	<title>特定對象辦理人數累計週報表</title>
	...
	<script language="javascript">
		function search() {
			...
			//if (isEmpty(document.form1.RIDValue)) { msg += '請選擇訓練機構!\n'; }
				...
				<table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
					<tr>
						<td>
							...
							首頁&gt;&gt;訓練查核與績效管理&gt;&gt;公務統計報表&gt;&gt;<font color="#990000">特定對象辦理人數累計週報表</font>
							</asp:Label>
						</td>
					</tr>
				</table>
