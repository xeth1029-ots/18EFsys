<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_02_004.aspx.vb" Inherits="WDAIIP.CR_02_004" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;二階審查&gt;&gt;審查課程明細表</asp:Label>
                </td>
            </tr>
        </table>
                ...
                <tr>
                    ...
                    <td class="whitecol"><%--RBLExpType2:1:通過彙整總表/2:通過明細表/3:未通過彙整總表/4:未通過明細表--%>
                        <asp:RadioButtonList ID="RBLExpType2" runat="server" CssClass="font" RepeatLayout="Flow" RepeatDirection="Horizontal">
                            <asp:ListItem Value="2" Selected="True">通過明細表</asp:ListItem>
                            <asp:ListItem Value="4">未通過明細表</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <td class="whitecol" colspan="2">※1.「課程分類」欄位：撈取審查幕僚意見 -「分署確認課程分類」資料。<br />
                        ※2.「【提案】課程分類」欄位：撈取訓練單位研提課程時的「職類課程」資料。<br />
                        ※3.當【申請階段】選擇「3：政策性產業」，即不區分計畫查詢</td>
                </tr>
                <tr>
