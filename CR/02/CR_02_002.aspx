<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_02_002.aspx.vb" Inherits="WDAIIP.CR_02_002" %>
    ...
    <form id="form1" runat="server">
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;二階審查&gt;&gt;申請核定差異統計表</asp:Label>
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="PanelSch1" runat="server">
            <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
                ...
                <tr>
                    <td class="whitecol" colspan="4">※1..當【申請階段】選擇「3：政策性產業」，即不區分計畫查詢</td>
                </tr>
                <tr>
