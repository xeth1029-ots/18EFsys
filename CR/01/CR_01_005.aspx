<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_01_005.aspx.vb" Inherits="WDAIIP.CR_01_005" %>
    ...
    <form id="form1" runat="server">
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td><%--1階/2階審查結果--%>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;二階審查&gt;&gt;核班結果</asp:Label>
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="PanelEdit1" runat="server">
            <table id="tbPanelEdit1" class="table_sch" border="0" cellspacing="1" cellpadding="1" width="100%">
                ...
                <tr>
                    <td class="bluecol" align="right">送請委員確認內容</td>
                    <td class="whitecol" colspan="3">
