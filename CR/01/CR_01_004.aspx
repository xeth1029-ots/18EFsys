<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_01_004.aspx.vb" Inherits="WDAIIP.CR_01_004" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td><%--1階/2階審查結果--%>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;一階審查&gt;&gt;委員審查結果</asp:Label>
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="PanelSch1" runat="server">
            <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
                ...
                <tr id="trBtnIMPORT1" runat="server">
                    <td class="bluecol">匯入送請委員確認內容 </td>
                    <%--匯入送請委員確認內容/匯入審查結果--%>
                    <td class="whitecol" colspan="3">
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="../../Doc/CR_01_004_IMPA3.zip" ForeColor="#8080FF">下載整批上載格式檔</asp:HyperLink>
                    </td>
                </tr>
                <tr id="trBtnIMPORT2" runat="server">
                    <td class="bluecol">匯入審查結果 </td>
                    <%--匯入送請委員確認內容/匯入審查結果--%>
                    <td class="whitecol" colspan="3">
                        <asp:CheckBox ID="ChkBxCover2" runat="server" Text="確定覆蓋" />
                        <input id="File2" type="file" size="66" name="File2" runat="server" accept=".xlsx" />
                        <asp:Button ID="BtnIMPORT2" runat="server" Text="匯入" CssClass="asp_button_M"></asp:Button>(必須為xlsx格式)
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="../../Doc/CR_01_004_IMPB3.zip" ForeColor="#8080FF">下載整批上載格式檔</asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="center">
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" Width="100%" AutoGenerateColumns="False" CellPadding="8">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="一階審查結果" ItemStyle-HorizontalAlign="Center">
                                    <ItemStyle CssClass="whitecol" />
                                    <ItemTemplate>
                                        <%--<asp:DropDownList ID="dg_RESULT" runat="server"></asp:DropDownList>--%>
                                        <asp:Label ID="labRESULT_N" runat="server" Text="一階審查結果"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
        ...
        <asp:Panel ID="PanelEdit1" runat="server">
            <table id="tbPanelEdit1" class="table_sch" border="0" cellspacing="1" cellpadding="1" width="100%">
                ...
                <tr>
                    ...
                    <td class="whitecol" colspan="3">
                        <asp:TextBox ID="ST1SUGGEST" runat="server" TextMode="multiline" Width="88%" Rows="10"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="bluecol">其他應修正內容</td>
                    <td class="whitecol" colspan="3">
                        <asp:TextBox ID="OTHFIXCONT" runat="server" TextMode="multiline" Width="88%" Rows="10"></asp:TextBox></td>
                </tr>
                ...
                <tr>
                    <td class="bluecol">分署確認課程分類</td>
                    <td class="whitecol" colspan="3">
                        <asp:DropDownList ID="ddlGCODE" runat="server"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="TC_TD3" align="right">送請委員確認內容</td>
                    <td class="whitecol" colspan="3">
                        <asp:TextBox ID="CONFIRMCONT" runat="server" TextMode="multiline" Width="88%" Rows="18"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="table_title" colspan="4">一階審查</td>
                </tr>
                <tr>
                    <td class="TC_TD3" align="right">委員審查意見與建議</td>
                    <td class="whitecol" colspan="3">
                        <asp:TextBox ID="COMMENTS" runat="server" TextMode="multiline" Width="88%" Rows="20"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="TC_TD3" align="right">一階審查結果<font color="#ff0000">*</font> </td>
                    <td class="whitecol" colspan="3">
