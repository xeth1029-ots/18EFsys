<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_01_003_Wrong.aspx.vb" Inherits="WDAIIP.CR_01_003_Wrong" %>
...
<body>
    <form id="form1" method="post" runat="server">
        <table id="table_Wrong" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="font" AllowPaging="true">
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="PSNO28" HeaderText="課程申請流水號"></asp:BoundColumn>
