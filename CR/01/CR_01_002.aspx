<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_01_002.aspx.vb" Inherits="WDAIIP.CR_01_002" %>
    ...
    <form id="form1" runat="server">
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;一階審查&gt;&gt;19大類審查分署設定</asp:Label>
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="panelSch" runat="server">
            <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
                ...
                <%--<tr><td class="bluecol" style="width: 20%">負責審查分署</td>
                    <td colspan="3" class="whitecol"><asp:DropDownList ID="ddlDISTID_SCH" runat="server"></asp:DropDownList></td>
                </tr>--%>
                <tr>
                    ...
                    <td align="center">
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="false" Width="100%" AutoGenerateColumns="False" CellPadding="8">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="GCODE_CNAME" HeaderText="19大職類" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="負責審查分署" ItemStyle-HorizontalAlign="Center">
