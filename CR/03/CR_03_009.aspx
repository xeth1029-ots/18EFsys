<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_03_009.aspx.vb" Inherits="WDAIIP.CR_03_009" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;【陳核版】課程核定報表&gt;&gt;未核班課程明細彙整表</asp:Label>
                </td>
            </tr>
        </table>
        <asp:Panel ID="PanelSch1" runat="server">
            <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
               <%--<tr><td class="bluecol_need" style="width: 18%">轄區分署</td><td class="whitecol" style="width: 82%"><asp:DropDownList ID="ddlDISTID_SCH" runat="server"></asp:DropDownList></td></tr>--%>
                <tr>
