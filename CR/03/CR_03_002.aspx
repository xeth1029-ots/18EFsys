<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_03_002.aspx.vb" Inherits="WDAIIP.CR_03_002" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;【陳核版】課程核定報表&gt;&gt;政策性產業核定課程統計</asp:Label>
                </td>
            </tr>
        </table>
            ...
            <table width="100%" cellpadding="1" cellspacing="1" class="table_sch">
                ...
                <tr>
                    <td class="whitecol" align="center" colspan="2">
                        ...
                        <asp:Button ID="BtnExport1" runat="server" Text="匯出統計表" CssClass="asp_Export_M"></asp:Button>
