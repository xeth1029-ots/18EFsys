<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CR_03_004.aspx.vb" Inherits="WDAIIP.CR_03_004" %>
        ...
        <table id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;課程審查&gt;&gt;【陳核版】課程核定報表&gt;&gt;管制類課程核定比例彙總表</asp:Label>
                </td>
            </tr>
        </table>
