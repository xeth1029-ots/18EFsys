<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_04_018_R.aspx.vb" Inherits="WDAIIP.TR_04_018" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>自辦職前穩定就業追蹤成果統計表</title>
        ...
        <tr>
            <td>
                <table class="font" id="Table2" cellspacing="1" cellpadding="1" width="100%" border="0">
                    <tr>
                        <td>
                            首頁&gt;&gt;訓練與就業需求管理&gt;&gt;就業追蹤報表&gt;&gt;<font color="#990000">自辦職前穩定就業追蹤成果統計表</font>
                        </td>
                    </tr>
                </table>
