<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_04_006_R.aspx.vb" Inherits="WDAIIP.TR_04_006_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
	<title>TR_04_006_R</title>
					...
					<tbody>
						<tr>
							<td width="90%" bgcolor="#ffffff">
								首頁&gt;&gt;訓練與就業需求管理&gt;&gt;就業追蹤報表&gt;&gt;<font color="#990000">職業訓練情形總表_依縣市別</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="showHide(0)" href="#"><font color="black">關閉</font></a>
							</td>
						</tr>
						<tr>
				...
				<table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
					<tr>
						<td title="點選可以查看說明" style="cursor: pointer" onclick="showHide(1)">
							首頁&gt;&gt;訓練與就業需求管理&gt;&gt;就業追蹤報表&gt;&gt;<font color="#990000">職業訓練情形總表_依縣市別</font>
						</td>
					</tr>
				</table>
				<table class="table_sch" id="Table2" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<td class="whitecol">
							...
							<input id="DistHidden" type="hidden" name="DistHidden">
						</td>
					</tr>
					<tr>
						<td class="bluecol">
