<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_04_016_R.aspx.vb" Inherits="WDAIIP.TR_04_016_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>TR_04_016_R</title>
        ...
        <tr>
            <td>
                <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                    <tr>
                        <td>
                            首頁&gt;&gt;訓練與就業需求管理&gt;&gt;就業追蹤報表&gt;&gt;<font color="#990000">與事業單位合作辦理-學員就業成果表</font>
                        </td>
                    </tr>
                </table>
