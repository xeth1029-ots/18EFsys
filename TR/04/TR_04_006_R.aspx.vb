Partial Class TR_04_006_R
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        'Dim DistID, newDistID, stitle, etitle As String
        '報表要用的轄區參數
        ...
        'sdate and edate 暫時不用傳，AP面先不改
        sdate = Syear.SelectedValue + "/1/1"
        edate = Syear.SelectedValue + "/12/31"
        'Dim cGuid As String =   ReportQuery.GetGuid(Page)
        'Dim Url As String =   ReportQuery.GetUrl(Page)
        'Dim strScript As String
        'strScript = "<script language=""javascript"">" + vbCrLf
        'strScript += "window.open('" & Url & "GUID=" + cGuid + "&SQ_AutoLogout=true&sys=TR&filename=TR_04_006_R&path=TIMS&TPlanID=" & TPlanID.SelectedValue & "&PYear=" & Syear.SelectedValue & "&PlanName='+escape('" & TPlanID.SelectedItem.Text & "')+'&AppliedDate=" & sdate & "&AppliedDate2=" & edate & "&DistID=" & newDistID & "&STDate1=" & STDate1.Text & "&STDate2=" & STDate2.Text & "&FTDate1=" & FTDate1.Text & "&FTDate2=" & FTDate2.Text & "&stitle=" & stitle & "&etitle=" & etitle & "');" + vbCrLf
        'strScript += "</script>"
        ...
        TIMS.CloseDbConn(objconn) : ReportQuery.PrintReport(Me, "Report", "TR_04_006_R", MyValue)
