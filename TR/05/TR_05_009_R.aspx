<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_05_009_R.aspx.vb" Inherits="WDAIIP.TR_05_009_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>年度訓練計畫參訓教育程度分佈</title>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Label ID="TitleLab2" runat="server">
										首頁&gt;&gt;訓練與就業需求管理&gt;&gt;統計分析&gt;&gt;<FONT color="#990000">年度訓練計畫參訓教育程度分佈</FONT>
                                    </asp:Label>
                                </td>
                            </tr>
                        </table>
