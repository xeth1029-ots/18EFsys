<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_05_007_R.aspx.vb" Inherits="WDAIIP.TR_05_007_R" %>
        ...
        <table id="FrameTable" border="0" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <td>
                    ...
                    <%--首頁&gt;&gt;訓練與就業需求管理&gt;&gt;統計分析&gt;&gt;<FONT color="#990000">年度訓練計畫特定對象人數分佈</FONT>--%>
                </td>
            </tr>
        </table>
