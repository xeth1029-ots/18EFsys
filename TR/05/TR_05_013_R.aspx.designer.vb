...
Partial Public Class TR_05_013_R
    ...
    '''若要修改，請將欄位宣告從設計工具檔案移到程式碼後置檔案。
    '''</remarks>
    Protected WithEvents HidCBLDISTID As Global.System.Web.UI.HtmlControls.HtmlInputHidden
    ...
    '''若要修改，請將欄位宣告從設計工具檔案移到程式碼後置檔案。
    '''</remarks>
    Protected WithEvents rblSearchStyle As Global.System.Web.UI.WebControls.RadioButtonList
