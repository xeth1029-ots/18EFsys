<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_05_011_R.aspx.vb" Inherits="WDAIIP.TR_05_011_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>TR_05_011_R</title>
    ...
    <script type="text/javascript">
        ...
        function search() {
            var msg = '';
            var PrintType = getValue('PrintType');
            //alert(PrintType);
            //return false;
            //debugger;
    ...
    <form id="form1" method="post" runat="server">
        <table id="FrameTable" border="0" cellspacing="1" cellpadding="1" width="100%">
            <tr>
                <td>
                    ...
                    <%--首頁&gt;&gt;訓練與就業需求管理&gt;&gt;統計分析&gt;&gt;<FONT color="#990000">訓練職類統計分析</FONT>--%>
                </td>
            </tr>
        </table>
        ...
        <table id="FrameTable3" border="0" cellspacing="1" cellpadding="1" width="100%">
            ...
            <tr>
                ...
                <td class="whitecol">
                    <asp:CheckBoxList ID="DistID" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatLayout="Flow" RepeatColumns="5">
                    </asp:CheckBoxList>
                    <input id="DistHidden" type="hidden" value="0" runat="server" name="DistHidden">
                </td>
            </tr>
            <tr>
                <td class="bluecol">縣市別
                </td>
                <td class="whitecol">
            ...
            <tr>
                ...
                <td class="whitecol" runat="server">
                    <asp:TextBox ID="STDate1" runat="server" Columns="10" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('STDate1','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30"><font color="#000000">～
                    <asp:TextBox ID="STDate2" runat="server" Columns="10" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('STDate2','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30"></font>
                </td>
            </tr>
            <tr>
                ...
                <td class="whitecol" runat="server">
                    <asp:TextBox ID="FTDate1" runat="server" Columns="10" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('FTDate1','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30"><font color="#000000">～
                    <asp:TextBox ID="FTDate2" runat="server" Columns="10" MaxLength="10"></asp:TextBox><img style="cursor: pointer" onclick="javascript:show_calendar('FTDate2','','','CY/MM/DD');" alt="" src="../../images/show-calendar.gif" align="top" width="30" height="30"></font>
                </td>
            </tr>
            <tr>
                ...
                <td class="whitecol">
                    <asp:RadioButtonList ID="PrintType" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1">依訓練職類</asp:ListItem>
                        <asp:ListItem Value="2">依通俗職類</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
