<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_05_024_R.aspx.vb" Inherits="WDAIIP.TR_05_024_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>地方政府績效統計表</title>
                ...
                <td>
                    <table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0" class="font">
                        <tr>
                            <td>
								...
								首頁&gt;&gt;訓練與就業需求管理&gt;&gt;統計分析&gt;&gt;<FONT color="#990000">地方政府績效統計表</FONT>
                                </asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table id="Table2" class="table_sch" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                            ...
                            <td class="whitecol">
                                <asp:CheckBoxList ID="TPlanIDList" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatColumns="3">
                                </asp:CheckBoxList>
                        ...
                        <tr>
                            ...
                            <td class="whitecol">&nbsp;<asp:CheckBoxList ID="DistIDList" runat="server" CssClass="font" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            </asp:CheckBoxList>
                    ...
                    <div align="center">
                        <%--<asp:Button ID="btnExport1" runat="server" Text="匯出班級統計表" CssClass="asp_button_M"></asp:Button>--%>
					&nbsp;
					<asp:Button ID="btnExport2" runat="server" Text="匯出班級明細表" CssClass="asp_Export_M"></asp:Button>
                    </div>
                    <%--<p align="center"></p>--%>
                </td>
            </tr>
