<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_05_017_R.aspx.vb" Inherits="WDAIIP.TR_05_017_R" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>各項訓練人數各分署比較表</title>
                ...
                <td>
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="TitleLab2" runat="server">首頁>>訓練與需求管理>>統計分析>>各項訓練人數各分署比較表</asp:Label></td>
                        </tr>
                    </table>
                    <table class="font" id="Table2" style="width: 696px; height: 285px" cellspacing="1" cellpadding="1"
                        ...
                        <tr id="TPlanID0_TR" runat="server">
                            <td class="CM_TD1" width="100"><font color="#ffffff">&nbsp;&nbsp;&nbsp; 訓練計畫(職前)</font></td>
                            <td class="CM_TD2">
                                <asp:CheckBoxList ID="chkTPlanID0" runat="server" CellSpacing="0" CellPadding="0" RepeatColumns="3"
                                    RepeatDirection="Horizontal" CssClass="font">
                                </asp:CheckBoxList><input id="TPlanID0HID" value="0" type="hidden" name="TPlanID0HID" runat="server"></td>
                        </tr>
                        <tr id="TPlanID1_TR" runat="server">
                            <td class="CM_TD1"><font color="#ffffff">&nbsp;&nbsp;&nbsp; 訓練計畫(在職)</font></td>
                            <td class="CM_TD2">
                                <asp:CheckBoxList ID="chkTPlanID1" runat="server" CellSpacing="0" CellPadding="0" RepeatColumns="3"
                                    RepeatDirection="Horizontal" CssClass="font">
                                </asp:CheckBoxList><input id="TPlanID1HID" value="0" type="hidden" name="TPlanID1HID" runat="server"></td>
                        </tr>
                        <tr id="TPlanIDX_TR" runat="server">
                            <td class="CM_TD1"><font color="#ffffff">&nbsp;&nbsp;&nbsp; 訓練計畫(其他)</font></td>
                            <td class="CM_TD2">
                                <asp:CheckBoxList ID="chkTPlanIDX" runat="server" CellSpacing="0" CellPadding="0" RepeatColumns="3"
                                    RepeatDirection="Horizontal" CssClass="font">
                                </asp:CheckBoxList><input id="TPlanIDXHID" value="0" type="hidden" name="TPlanIDXHID" runat="server"></td>
                        </tr>
                        <%--
							<TR>
								<TD class="CM_TD1"><FONT face="新細明體">&nbsp;&nbsp;&nbsp; 訓練計畫 <FONT color="#ff0000">*</FONT></FONT></TD>
								<TD class="CM_TD2"><asp:checkboxlist id="TPlanID" runat="server" RepeatDirection="Horizontal" CssClass="font" CellSpacing="0"
										CellPadding="0" RepeatColumns="3"></asp:checkboxlist><INPUT id="TPlanHidden" type="hidden" value="0" name="TPlanHidden" runat="server">
								</TD>
							</TR>
                        --%>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="2"><font face="新細明體">
                                <asp:Button ID="Print" runat="server" Text="列印" CssClass="asp_Export_M"></asp:Button></font></td>
                        </tr>
                    </table>
                </td>
            </tr>
