<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TR_01_001.aspx.vb" Inherits="WDAIIP.TR_01_001" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>TR_01_001</title>
    <meta content="Microsoft Visual Studio .NET 7.1" name="GENERATOR">
    <meta content="Visual Basic .NET 7.1" name="CODE_LANGUAGE">
    <meta content="JavaScript" name="vs_defaultClientScript">
    <meta content="http://schemas.microsoft.com/intellisense/ie5" name="vs_targetSchema">
    <link href="../../css/style.css" type="text/css" rel="stylesheet">
    <script language="javascript" src="../../js/TIMS.js"></script>
            ...
            <tr>
                <td>
                    <table class="font" id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            <td>
                                首頁&gt;&gt;訓練與需求管理&gt;&gt;開券資料統計&gt;&gt;<font color="#990000">核券人數統計表</font>
                            </td>
                        </tr>
                    </table>
                    <table class="table_sch" id="Table2" cellspacing="1" cellpadding="1">
                        <tr>
                            <td width="80" class="bluecol">
                                券別種類
                            </td>
                            <td class="whitecol">
                                ...
                                <asp:RadioButtonList ID="TICKET_TYPE" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
