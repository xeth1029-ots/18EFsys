<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CM_03_014_B.aspx.vb" Inherits="WDAIIP.CM_03_014_B" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <input id="Yearsb" type="hidden" name="Yearsb" runat="server">
        <input id="DistIDb" type="hidden" name="DistIDb" runat="server">
        <input id="TPlanIDb" type="hidden" name="TPlanIDb" runat="server">
        <input id="PlanIDb" type="hidden" name="PlanIDb" runat="server">
    </form>
</body>
</html>
