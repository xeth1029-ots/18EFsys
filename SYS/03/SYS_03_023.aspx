<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SYS_03_023.aspx.vb" Inherits="WDAIIP.SYS_03_023" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <tr>
            <td class="font">
                首頁&gt;&gt;系統管理&gt;&gt;功能權限管理&gt;&gt;<font color="#990000"><font color="#990000">計畫群組設定<font face="Times New Roman" size="2"></font></font></font>
            </td>
        </tr>
    </table>--%>
        ...
        <table class="font" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server" id="Table2">
            <tr>
                <td align="center">
                    <asp:DataGrid ID="DataGrid1" CssClass="font" Width="100%" AutoGenerateColumns="False" runat="server" CellPadding="8">
