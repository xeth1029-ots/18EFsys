<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SYS_04_015.aspx.vb" Inherits="WDAIIP.SYS_04_015" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveResults() {
            ...
            var jobULs = $("ul[id^=lv_orgQueryResult]");
        ...
        function doSave(data) {
            ...
            var PostURL_1 = "<%=ResolveUrl("~/ajax/SaveClassGeoLocator2.ashx")%>";
        ...
        function geoLocator() {
            ...
            var qryULs = $("ul[id^=lv_orgQueryResult]");
            total = qryULs.length;
            success = 0;
            failed = 0;
            i = 0;
    ...
    <form id="form1" runat="server">
        <table class="font" id="FrameTable" cellspacing="1" cellpadding="1" width="100%" border="0">
            <tr>
                <td>
                    ...
                    <asp:Label ID="TitleLab2" runat="server">首頁&gt;&gt;系統管理&gt;&gt;系統參數管理&gt;&gt;TGOS地址定位機構</asp:Label>
                </td>
            </tr>
        </table>
        <div id="schclass1">
            <dl>
                <dt>分署機構</dt>
                <dd>
                    <asp:RadioButtonList ID="RB_LID" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <asp:ListItem Value="1">分署</asp:ListItem>
                        <asp:ListItem Selected="True" Value="2">機構</asp:ListItem>
                    </asp:RadioButtonList>
                </dd>
                <dt>查詢筆數</dt>
                <dd>
                ...
                <dt>機構流水號RSID</dt>
                <dd>
                    <asp:TextBox ID="txtRSID2" runat="server" MaxLength="10" Columns="6"></asp:TextBox></dd>
                <dt>調整地址</dt>
                <dd>
        ...
        <div>
            <div id="classQueryDiv1" runat="server">
                ...
                <asp:ListView ID="lv_orgQueryResult" runat="server">
                    <ItemTemplate>
                        <ul runat="server" id="classItemUL" data-checked="Y">
                            <li>
                                <span id="spRSID"><asp:Literal ID="litRSID" runat="server"></asp:Literal></span>
                                <input type="checkbox" checked="checked" />
                            </li>
                            <li>
                                <span id="spOrgName"><asp:Literal ID="litOrgName" runat="server"></asp:Literal></span>
                            </li>
                            <li>
